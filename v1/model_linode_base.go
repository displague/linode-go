...
// SetType gets a reference to the given Id and assigns it to the Type field.
...
func (o LinodeBase) MarshalJSON() ([]byte, error) {
...
type NullableLinodeBase struct {
	value *LinodeBase
	isSet bool
}

func (v NullableLinodeBase) Get() *LinodeBase {
	return v.value
}

func (v *NullableLinodeBase) Set(val *LinodeBase) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeBase) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeBase(val *LinodeBase) *NullableLinodeBase {
	return &NullableLinodeBase{value: val, isSet: true}
}

func (v NullableLinodeBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
