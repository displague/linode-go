...
func (o ObjectStorageSSLResponse) MarshalJSON() ([]byte, error) {
...
type NullableObjectStorageSSLResponse struct {
	value *ObjectStorageSSLResponse
	isSet bool
}

func (v NullableObjectStorageSSLResponse) Get() *ObjectStorageSSLResponse {
	return v.value
}

func (v *NullableObjectStorageSSLResponse) Set(val *ObjectStorageSSLResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStorageSSLResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStorageSSLResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStorageSSLResponse(val *ObjectStorageSSLResponse) *NullableObjectStorageSSLResponse {
	return &NullableObjectStorageSSLResponse{value: val, isSet: true}
}

func (v NullableObjectStorageSSLResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStorageSSLResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
