...
type ApiCreateLongviewClientRequest struct {
	ctx _context.Context
	ApiService *LongviewApiService
	longviewClient *LongviewClient
}

func (r ApiCreateLongviewClientRequest) LongviewClient(longviewClient LongviewClient) ApiCreateLongviewClientRequest {
	r.longviewClient = &longviewClient
	return r
}

func (r ApiCreateLongviewClientRequest) Execute() (LongviewClient, *_nethttp.Response, error) {
	return r.ApiService.CreateLongviewClientExecute(r)
}
 ...
 * @return ApiCreateLongviewClientRequest
 */
func (a *LongviewApiService) CreateLongviewClient(ctx _context.Context) ApiCreateLongviewClientRequest {
	return ApiCreateLongviewClientRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *LongviewApiService) CreateLongviewClientExecute(r ApiCreateLongviewClientRequest) (LongviewClient, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  LongviewClient
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LongviewApiService.CreateLongviewClient")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/longview/clients"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.longviewClient == nil {
		return localVarReturnValue, nil, reportError("longviewClient is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.longviewClient
...
func (r ApiDeleteLongviewClientRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *LongviewApiService) DeleteLongviewClient(ctx _context.Context, clientId int32) ApiDeleteLongviewClientRequest {
	return ApiDeleteLongviewClientRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
 ...
 */
func (a *LongviewApiService) DeleteLongviewClientExecute(r ApiDeleteLongviewClientRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/longview/clients/{clientId}"
...
func (r ApiGetLongviewClientRequest) Execute() (LongviewClient, *_nethttp.Response, error) {
 ...
 */
func (a *LongviewApiService) GetLongviewClient(ctx _context.Context, clientId int32) ApiGetLongviewClientRequest {
	return ApiGetLongviewClientRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
 ...
 * @return LongviewClient
 */
func (a *LongviewApiService) GetLongviewClientExecute(r ApiGetLongviewClientRequest) (LongviewClient, *_nethttp.Response, error) {
	var (
...
func (r ApiGetLongviewClientsRequest) Execute() (InlineResponse20031, *_nethttp.Response, error) {
 ...
 */
func (a *LongviewApiService) GetLongviewClients(ctx _context.Context) ApiGetLongviewClientsRequest {
	return ApiGetLongviewClientsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *LongviewApiService) GetLongviewClientsExecute(r ApiGetLongviewClientsRequest) (InlineResponse20031, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetLongviewPlanRequest) Execute() (LongviewSubscription, *_nethttp.Response, error) {
 ...
 */
func (a *LongviewApiService) GetLongviewPlan(ctx _context.Context) ApiGetLongviewPlanRequest {
	return ApiGetLongviewPlanRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *LongviewApiService) GetLongviewPlanExecute(r ApiGetLongviewPlanRequest) (LongviewSubscription, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  LongviewSubscription
	)
	...
	localVarPath := localBasePath + "/longview/plan"
...
func (r ApiGetLongviewSubscriptionRequest) Execute() (LongviewSubscription, *_nethttp.Response, error) {
 ...
 */
func (a *LongviewApiService) GetLongviewSubscription(ctx _context.Context, subscriptionId string) ApiGetLongviewSubscriptionRequest {
	return ApiGetLongviewSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
 ...
 * @return LongviewSubscription
 */
func (a *LongviewApiService) GetLongviewSubscriptionExecute(r ApiGetLongviewSubscriptionRequest) (LongviewSubscription, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/longview/subscriptions/{subscriptionId}"
...
func (r ApiGetLongviewSubscriptionsRequest) Execute() (InlineResponse20032, *_nethttp.Response, error) {
 ...
 */
func (a *LongviewApiService) GetLongviewSubscriptions(ctx _context.Context) ApiGetLongviewSubscriptionsRequest {
	return ApiGetLongviewSubscriptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *LongviewApiService) GetLongviewSubscriptionsExecute(r ApiGetLongviewSubscriptionsRequest) (InlineResponse20032, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/longview/subscriptions"
...
type ApiUpdateLongviewClientRequest struct {
	ctx _context.Context
	ApiService *LongviewApiService
	clientId int32
	longviewClient *LongviewClient
...
func (r ApiUpdateLongviewClientRequest) LongviewClient(longviewClient LongviewClient) ApiUpdateLongviewClientRequest {
	r.longviewClient = &longviewClient
	return r
}

func (r ApiUpdateLongviewClientRequest) Execute() (LongviewClient, *_nethttp.Response, error) {
	return r.ApiService.UpdateLongviewClientExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clientId The Longview Client ID to access.
 * @return ApiUpdateLongviewClientRequest
 */
func (a *LongviewApiService) UpdateLongviewClient(ctx _context.Context, clientId int32) ApiUpdateLongviewClientRequest {
	return ApiUpdateLongviewClientRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
 ...
 * @return LongviewClient
 */
func (a *LongviewApiService) UpdateLongviewClientExecute(r ApiUpdateLongviewClientRequest) (LongviewClient, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LongviewApiService.UpdateLongviewClient")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateLongviewPlanRequest struct {
	ctx _context.Context
	ApiService *LongviewApiService
	longviewPlan *LongviewPlan
}

func (r ApiUpdateLongviewPlanRequest) LongviewPlan(longviewPlan LongviewPlan) ApiUpdateLongviewPlanRequest {
	r.longviewPlan = &longviewPlan
	return r
}

func (r ApiUpdateLongviewPlanRequest) Execute() (LongviewSubscription, *_nethttp.Response, error) {
	return r.ApiService.UpdateLongviewPlanExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiUpdateLongviewPlanRequest
 */
func (a *LongviewApiService) UpdateLongviewPlan(ctx _context.Context) ApiUpdateLongviewPlanRequest {
	return ApiUpdateLongviewPlanRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return LongviewSubscription
 */
func (a *LongviewApiService) UpdateLongviewPlanExecute(r ApiUpdateLongviewPlanRequest) (LongviewSubscription, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LongviewApiService.UpdateLongviewPlan")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.longviewPlan == nil {
		return localVarReturnValue, nil, reportError("longviewPlan is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.longviewPlan
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
