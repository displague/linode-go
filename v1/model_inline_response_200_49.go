...
type InlineResponse20049 struct {
	Data *[]ObjectStorageCluster `json:"data,omitempty"`
...
// SetData gets a reference to the given []ObjectStorageCluster and assigns it to the Data field.
