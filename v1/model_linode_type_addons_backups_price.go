...
func NewLinodeTypeAddonsBackupsPrice() *LinodeTypeAddonsBackupsPrice {
	this := LinodeTypeAddonsBackupsPrice{}
	return &this
}
...
func (o LinodeTypeAddonsBackupsPrice) MarshalJSON() ([]byte, error) {
...
type NullableLinodeTypeAddonsBackupsPrice struct {
	value *LinodeTypeAddonsBackupsPrice
	isSet bool
}

func (v NullableLinodeTypeAddonsBackupsPrice) Get() *LinodeTypeAddonsBackupsPrice {
	return v.value
}

func (v *NullableLinodeTypeAddonsBackupsPrice) Set(val *LinodeTypeAddonsBackupsPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeTypeAddonsBackupsPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeTypeAddonsBackupsPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeTypeAddonsBackupsPrice(val *LinodeTypeAddonsBackupsPrice) *NullableLinodeTypeAddonsBackupsPrice {
	return &NullableLinodeTypeAddonsBackupsPrice{value: val, isSet: true}
}

func (v NullableLinodeTypeAddonsBackupsPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeTypeAddonsBackupsPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
