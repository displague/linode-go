...
func (o *GrantsResponseGlobal) GetLongviewSubscription() bool {
	if o == nil || o.LongviewSubscription == nil {
		var ret bool
		return ret
	}
...
func (o *GrantsResponseGlobal) GetAccountAccess() string {
	if o == nil || o.AccountAccess.Get() == nil {
		var ret string
		return ret
	}
...
func (o *GrantsResponseGlobal) SetAccountAccessNil() {
...
func (o *GrantsResponseGlobal) GetAddStackscripts() bool {
	if o == nil || o.AddStackscripts == nil {
		var ret bool
		return ret
	}
...
func (o *GrantsResponseGlobal) GetAddNodebalancers() bool {
	if o == nil || o.AddNodebalancers == nil {
		var ret bool
		return ret
	}
...
func (o GrantsResponseGlobal) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.AddLinodes != nil {
		toSerialize["add_linodes"] = o.AddLinodes
	}
	if o.AddLongview != nil {
		toSerialize["add_longview"] = o.AddLongview
	}
	if o.LongviewSubscription != nil {
...
type NullableGrantsResponseGlobal struct {
	value *GrantsResponseGlobal
	isSet bool
}

func (v NullableGrantsResponseGlobal) Get() *GrantsResponseGlobal {
	return v.value
}

func (v *NullableGrantsResponseGlobal) Set(val *GrantsResponseGlobal) {
	v.value = val
	v.isSet = true
}

func (v NullableGrantsResponseGlobal) IsSet() bool {
	return v.isSet
}

func (v *NullableGrantsResponseGlobal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGrantsResponseGlobal(val *GrantsResponseGlobal) *NullableGrantsResponseGlobal {
	return &NullableGrantsResponseGlobal{value: val, isSet: true}
}

func (v NullableGrantsResponseGlobal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGrantsResponseGlobal) UnmarshalJSON(src []byte) error {
	v.isSet = true
