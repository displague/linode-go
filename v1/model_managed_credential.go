...
func (o ManagedCredential) MarshalJSON() ([]byte, error) {
	...
	if o.LastDecrypted != nil {
		toSerialize["last_decrypted"] = o.LastDecrypted
	}
	return json.Marshal(toSerialize)
}

type NullableManagedCredential struct {
	value *ManagedCredential
	isSet bool
}

func (v NullableManagedCredential) Get() *ManagedCredential {
	return v.value
}

func (v *NullableManagedCredential) Set(val *ManagedCredential) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedCredential) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedCredential) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedCredential(val *ManagedCredential) *NullableManagedCredential {
	return &NullableManagedCredential{value: val, isSet: true}
}

func (v NullableManagedCredential) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedCredential) UnmarshalJSON(src []byte) error {
	v.isSet = true
