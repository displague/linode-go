...
func (o *LinodeTypeAddonsBackups) GetPrice() LinodeTypeAddonsBackupsPrice {
	if o == nil || o.Price == nil {
		var ret LinodeTypeAddonsBackupsPrice
		return ret
	}
	return *o.Price
}
...
// SetPrice gets a reference to the given LinodeTypeAddonsBackupsPrice and assigns it to the Price field.
func (o *LinodeTypeAddonsBackups) SetPrice(v LinodeTypeAddonsBackupsPrice) {
	o.Price = &v
}

func (o LinodeTypeAddonsBackups) MarshalJSON() ([]byte, error) {
...
type NullableLinodeTypeAddonsBackups struct {
	value *LinodeTypeAddonsBackups
	isSet bool
}

func (v NullableLinodeTypeAddonsBackups) Get() *LinodeTypeAddonsBackups {
	return v.value
}

func (v *NullableLinodeTypeAddonsBackups) Set(val *LinodeTypeAddonsBackups) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeTypeAddonsBackups) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeTypeAddonsBackups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeTypeAddonsBackups(val *LinodeTypeAddonsBackups) *NullableLinodeTypeAddonsBackups {
	return &NullableLinodeTypeAddonsBackups{value: val, isSet: true}
}

func (v NullableLinodeTypeAddonsBackups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeTypeAddonsBackups) UnmarshalJSON(src []byte) error {
	v.isSet = true
