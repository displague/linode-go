...
func (o *NodeBalancerStatsData) GetTraffic() NodeBalancerStatsDataTraffic {
	if o == nil || o.Traffic == nil {
		var ret NodeBalancerStatsDataTraffic
		return ret
	}
	return *o.Traffic
}
...
// SetTraffic gets a reference to the given NodeBalancerStatsDataTraffic and assigns it to the Traffic field.
func (o *NodeBalancerStatsData) SetTraffic(v NodeBalancerStatsDataTraffic) {
	o.Traffic = &v
}

func (o NodeBalancerStatsData) MarshalJSON() ([]byte, error) {
...
type NullableNodeBalancerStatsData struct {
	value *NodeBalancerStatsData
	isSet bool
}

func (v NullableNodeBalancerStatsData) Get() *NodeBalancerStatsData {
	return v.value
}

func (v *NullableNodeBalancerStatsData) Set(val *NodeBalancerStatsData) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeBalancerStatsData) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeBalancerStatsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeBalancerStatsData(val *NodeBalancerStatsData) *NullableNodeBalancerStatsData {
	return &NullableNodeBalancerStatsData{value: val, isSet: true}
}

func (v NullableNodeBalancerStatsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeBalancerStatsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
