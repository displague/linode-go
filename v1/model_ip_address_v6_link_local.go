...
type IPAddressV6LinkLocal struct {
...
func (o IPAddressV6LinkLocal) MarshalJSON() ([]byte, error) {
...
type NullableIPAddressV6LinkLocal struct {
	value *IPAddressV6LinkLocal
	isSet bool
}

func (v NullableIPAddressV6LinkLocal) Get() *IPAddressV6LinkLocal {
	return v.value
}

func (v *NullableIPAddressV6LinkLocal) Set(val *IPAddressV6LinkLocal) {
	v.value = val
	v.isSet = true
}

func (v NullableIPAddressV6LinkLocal) IsSet() bool {
	return v.isSet
}

func (v *NullableIPAddressV6LinkLocal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPAddressV6LinkLocal(val *IPAddressV6LinkLocal) *NullableIPAddressV6LinkLocal {
	return &NullableIPAddressV6LinkLocal{value: val, isSet: true}
}

func (v NullableIPAddressV6LinkLocal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPAddressV6LinkLocal) UnmarshalJSON(src []byte) error {
	v.isSet = true
