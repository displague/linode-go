...
func (o LKENodeStatus) MarshalJSON() ([]byte, error) {
...
type NullableLKENodeStatus struct {
	value *LKENodeStatus
	isSet bool
}

func (v NullableLKENodeStatus) Get() *LKENodeStatus {
	return v.value
}

func (v *NullableLKENodeStatus) Set(val *LKENodeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableLKENodeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableLKENodeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLKENodeStatus(val *LKENodeStatus) *NullableLKENodeStatus {
	return &NullableLKENodeStatus{value: val, isSet: true}
}

func (v NullableLKENodeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLKENodeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
