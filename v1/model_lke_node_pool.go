...
// LKENodePool The set of Node Pools which are members of the Kubernetes cluster. Node Pools consist of a Linode type, the number of Linodes to deploy of that type, and additional status information. 
type LKENodePool struct {
	...
	Disks *[]LKENodePoolRequestBodyDisks `json:"disks,omitempty"`
}
...
// SetNodes gets a reference to the given []LKENodeStatus and assigns it to the Nodes field.
...
func (o *LKENodePool) GetDisks() []LKENodePoolRequestBodyDisks {
	if o == nil || o.Disks == nil {
		var ret []LKENodePoolRequestBodyDisks
		return ret
	}
	return *o.Disks
}
...
// SetDisks gets a reference to the given []LKENodePoolRequestBodyDisks and assigns it to the Disks field.
func (o *LKENodePool) SetDisks(v []LKENodePoolRequestBodyDisks) {
	o.Disks = &v
}

func (o LKENodePool) MarshalJSON() ([]byte, error) {
...
type NullableLKENodePool struct {
	value *LKENodePool
	isSet bool
}

func (v NullableLKENodePool) Get() *LKENodePool {
	return v.value
}

func (v *NullableLKENodePool) Set(val *LKENodePool) {
	v.value = val
	v.isSet = true
}

func (v NullableLKENodePool) IsSet() bool {
	return v.isSet
}

func (v *NullableLKENodePool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLKENodePool(val *LKENodePool) *NullableLKENodePool {
	return &NullableLKENodePool{value: val, isSet: true}
}

func (v NullableLKENodePool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLKENodePool) UnmarshalJSON(src []byte) error {
	v.isSet = true
