...
func (o *LongviewSubscription) GetPrice() LongviewSubscriptionPrice {
	if o == nil || o.Price == nil {
		var ret LongviewSubscriptionPrice
		return ret
	}
	return *o.Price
}
...
// SetPrice gets a reference to the given LongviewSubscriptionPrice and assigns it to the Price field.
...
func (o *LongviewSubscription) GetClientsIncluded() int32 {
	if o == nil || o.ClientsIncluded == nil {
		var ret int32
		return ret
	}
...
func (o LongviewSubscription) MarshalJSON() ([]byte, error) {
	...
	if o.ClientsIncluded != nil {
		toSerialize["clients_included"] = o.ClientsIncluded
	}
	return json.Marshal(toSerialize)
}

type NullableLongviewSubscription struct {
	value *LongviewSubscription
	isSet bool
}

func (v NullableLongviewSubscription) Get() *LongviewSubscription {
	return v.value
}

func (v *NullableLongviewSubscription) Set(val *LongviewSubscription) {
	v.value = val
	v.isSet = true
}

func (v NullableLongviewSubscription) IsSet() bool {
	return v.isSet
}

func (v *NullableLongviewSubscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLongviewSubscription(val *LongviewSubscription) *NullableLongviewSubscription {
	return &NullableLongviewSubscription{value: val, isSet: true}
}

func (v NullableLongviewSubscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLongviewSubscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
