...
func (r ApiCreateImageRequest) UNKNOWNBASETYPE(uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) ApiCreateImageRequest {
	r.uNKNOWNBASETYPE = &uNKNOWNBASETYPE
	return r
}

func (r ApiCreateImageRequest) Execute() (ImagePrivate, *_nethttp.Response, error) {
 ...
 */
func (a *ImagesApiService) CreateImage(ctx _context.Context) ApiCreateImageRequest {
	return ApiCreateImageRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return ImagePrivate
 */
func (a *ImagesApiService) CreateImageExecute(r ApiCreateImageRequest) (ImagePrivate, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ImagePrivate
	)
...
func (r ApiDeleteImageRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param imageId ID of the Image to look up.
 ...
 */
func (a *ImagesApiService) DeleteImageExecute(r ApiDeleteImageRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (r ApiGetImageRequest) Execute() (ImagePrivate, *_nethttp.Response, error) {
 ...
 */
func (a *ImagesApiService) GetImage(ctx _context.Context, imageId string) ApiGetImageRequest {
	return ApiGetImageRequest{
		ApiService: a,
		ctx: ctx,
		imageId: imageId,
 ...
 * @return ImagePrivate
 */
func (a *ImagesApiService) GetImageExecute(r ApiGetImageRequest) (ImagePrivate, *_nethttp.Response, error) {
	var (
...
func (r ApiGetImagesRequest) Execute() (InlineResponse20014, *_nethttp.Response, error) {
 ...
 */
func (a *ImagesApiService) GetImages(ctx _context.Context) ApiGetImagesRequest {
	return ApiGetImagesRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *ImagesApiService) GetImagesExecute(r ApiGetImagesRequest) (InlineResponse20014, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateImageRequest) ImagePrivate(imagePrivate ImagePrivate) ApiUpdateImageRequest {
	r.imagePrivate = &imagePrivate
	return r
}

func (r ApiUpdateImageRequest) Execute() (ImagePrivate, *_nethttp.Response, error) {
 ...
 * @return ImagePrivate
 */
func (a *ImagesApiService) UpdateImageExecute(r ApiUpdateImageRequest) (ImagePrivate, *_nethttp.Response, error) {
	var (
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.imagePrivate == nil {
		return localVarReturnValue, nil, reportError("imagePrivate is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.imagePrivate
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
