...
// SetGlobal gets a reference to the given GrantsResponseGlobal and assigns it to the Global field.
...
// SetLinode gets a reference to the given []Grant and assigns it to the Linode field.
...
// SetDomain gets a reference to the given []Grant and assigns it to the Domain field.
...
// SetNodebalancer gets a reference to the given []Grant and assigns it to the Nodebalancer field.
...
// SetImage gets a reference to the given []Grant and assigns it to the Image field.
...
// SetLongview gets a reference to the given []Grant and assigns it to the Longview field.
...
// SetStackscript gets a reference to the given []Grant and assigns it to the Stackscript field.
...
// SetVolume gets a reference to the given []Grant and assigns it to the Volume field.
