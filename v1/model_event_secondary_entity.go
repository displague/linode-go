...
func (o EventSecondaryEntity) MarshalJSON() ([]byte, error) {
...
type NullableEventSecondaryEntity struct {
	value *EventSecondaryEntity
	isSet bool
}

func (v NullableEventSecondaryEntity) Get() *EventSecondaryEntity {
	return v.value
}

func (v *NullableEventSecondaryEntity) Set(val *EventSecondaryEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableEventSecondaryEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableEventSecondaryEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventSecondaryEntity(val *EventSecondaryEntity) *NullableEventSecondaryEntity {
	return &NullableEventSecondaryEntity{value: val, isSet: true}
}

func (v NullableEventSecondaryEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventSecondaryEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
