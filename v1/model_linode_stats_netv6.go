...
func (o LinodeStatsNetv6) MarshalJSON() ([]byte, error) {
...
type NullableLinodeStatsNetv6 struct {
	value *LinodeStatsNetv6
	isSet bool
}

func (v NullableLinodeStatsNetv6) Get() *LinodeStatsNetv6 {
	return v.value
}

func (v *NullableLinodeStatsNetv6) Set(val *LinodeStatsNetv6) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeStatsNetv6) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeStatsNetv6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeStatsNetv6(val *LinodeStatsNetv6) *NullableLinodeStatsNetv6 {
	return &NullableLinodeStatsNetv6{value: val, isSet: true}
}

func (v NullableLinodeStatsNetv6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeStatsNetv6) UnmarshalJSON(src []byte) error {
	v.isSet = true
