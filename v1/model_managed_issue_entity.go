...
func (o ManagedIssueEntity) MarshalJSON() ([]byte, error) {
...
type NullableManagedIssueEntity struct {
	value *ManagedIssueEntity
	isSet bool
}

func (v NullableManagedIssueEntity) Get() *ManagedIssueEntity {
	return v.value
}

func (v *NullableManagedIssueEntity) Set(val *ManagedIssueEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedIssueEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedIssueEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedIssueEntity(val *ManagedIssueEntity) *NullableManagedIssueEntity {
	return &NullableManagedIssueEntity{value: val, isSet: true}
}

func (v NullableManagedIssueEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedIssueEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
