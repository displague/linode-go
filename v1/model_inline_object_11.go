...
type InlineObject11 struct {
	...
	Devices *NetworkingFirewallsDevices `json:"devices,omitempty"`
}
...
func (o *InlineObject11) GetDevices() NetworkingFirewallsDevices {
	if o == nil || o.Devices == nil {
		var ret NetworkingFirewallsDevices
		return ret
	}
	return *o.Devices
}
...
// SetDevices gets a reference to the given NetworkingFirewallsDevices and assigns it to the Devices field.
