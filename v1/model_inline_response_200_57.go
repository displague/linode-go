...
type InlineResponse20057 struct {
	Data *[]SupportTicketReply `json:"data,omitempty"`
...
// SetData gets a reference to the given []SupportTicketReply and assigns it to the Data field.
