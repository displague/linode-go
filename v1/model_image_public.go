...
func (o ImagePublic) MarshalJSON() ([]byte, error) {
...
type NullableImagePublic struct {
	value *ImagePublic
	isSet bool
}

func (v NullableImagePublic) Get() *ImagePublic {
	return v.value
}

func (v *NullableImagePublic) Set(val *ImagePublic) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePublic) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePublic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePublic(val *ImagePublic) *NullableImagePublic {
	return &NullableImagePublic{value: val, isSet: true}
}

func (v NullableImagePublic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePublic) UnmarshalJSON(src []byte) error {
	v.isSet = true
