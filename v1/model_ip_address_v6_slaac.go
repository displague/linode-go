...
func (o IPAddressV6Slaac) MarshalJSON() ([]byte, error) {
...
type NullableIPAddressV6Slaac struct {
	value *IPAddressV6Slaac
	isSet bool
}

func (v NullableIPAddressV6Slaac) Get() *IPAddressV6Slaac {
	return v.value
}

func (v *NullableIPAddressV6Slaac) Set(val *IPAddressV6Slaac) {
	v.value = val
	v.isSet = true
}

func (v NullableIPAddressV6Slaac) IsSet() bool {
	return v.isSet
}

func (v *NullableIPAddressV6Slaac) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPAddressV6Slaac(val *IPAddressV6Slaac) *NullableIPAddressV6Slaac {
	return &NullableIPAddressV6Slaac{value: val, isSet: true}
}

func (v NullableIPAddressV6Slaac) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPAddressV6Slaac) UnmarshalJSON(src []byte) error {
	v.isSet = true
