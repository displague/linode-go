...
func (o LKENodePoolRequestBody) MarshalJSON() ([]byte, error) {
...
type NullableLKENodePoolRequestBody struct {
	value *LKENodePoolRequestBody
	isSet bool
}

func (v NullableLKENodePoolRequestBody) Get() *LKENodePoolRequestBody {
	return v.value
}

func (v *NullableLKENodePoolRequestBody) Set(val *LKENodePoolRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableLKENodePoolRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableLKENodePoolRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLKENodePoolRequestBody(val *LKENodePoolRequestBody) *NullableLKENodePoolRequestBody {
	return &NullableLKENodePoolRequestBody{value: val, isSet: true}
}

func (v NullableLKENodePoolRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLKENodePoolRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
