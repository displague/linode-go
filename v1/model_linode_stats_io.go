...
func (o LinodeStatsIo) MarshalJSON() ([]byte, error) {
...
type NullableLinodeStatsIo struct {
	value *LinodeStatsIo
	isSet bool
}

func (v NullableLinodeStatsIo) Get() *LinodeStatsIo {
	return v.value
}

func (v *NullableLinodeStatsIo) Set(val *LinodeStatsIo) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeStatsIo) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeStatsIo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeStatsIo(val *LinodeStatsIo) *NullableLinodeStatsIo {
	return &NullableLinodeStatsIo{value: val, isSet: true}
}

func (v NullableLinodeStatsIo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeStatsIo) UnmarshalJSON(src []byte) error {
	v.isSet = true
