...
// SetSda gets a reference to the given Device and assigns it to the Sda field.
...
// SetSdb gets a reference to the given Device and assigns it to the Sdb field.
...
// SetSdc gets a reference to the given Device and assigns it to the Sdc field.
...
// SetSdd gets a reference to the given Device and assigns it to the Sdd field.
...
// SetSde gets a reference to the given Device and assigns it to the Sde field.
...
// SetSdf gets a reference to the given Device and assigns it to the Sdf field.
...
// SetSdg gets a reference to the given Device and assigns it to the Sdg field.
func (o *RescueDevices) SetSdg(v Device) {
	o.Sdg = &v
}

func (o RescueDevices) MarshalJSON() ([]byte, error) {
...
type NullableRescueDevices struct {
	value *RescueDevices
	isSet bool
}

func (v NullableRescueDevices) Get() *RescueDevices {
	return v.value
}

func (v *NullableRescueDevices) Set(val *RescueDevices) {
	v.value = val
	v.isSet = true
}

func (v NullableRescueDevices) IsSet() bool {
	return v.isSet
}

func (v *NullableRescueDevices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRescueDevices(val *RescueDevices) *NullableRescueDevices {
	return &NullableRescueDevices{value: val, isSet: true}
}

func (v NullableRescueDevices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRescueDevices) UnmarshalJSON(src []byte) error {
	v.isSet = true
