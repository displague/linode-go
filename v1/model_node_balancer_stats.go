...
// SetData gets a reference to the given NodeBalancerStatsData and assigns it to the Data field.
...
func (o NodeBalancerStats) MarshalJSON() ([]byte, error) {
...
type NullableNodeBalancerStats struct {
	value *NodeBalancerStats
	isSet bool
}

func (v NullableNodeBalancerStats) Get() *NodeBalancerStats {
	return v.value
}

func (v *NullableNodeBalancerStats) Set(val *NodeBalancerStats) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeBalancerStats) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeBalancerStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeBalancerStats(val *NodeBalancerStats) *NullableNodeBalancerStats {
	return &NullableNodeBalancerStats{value: val, isSet: true}
}

func (v NullableNodeBalancerStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeBalancerStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
