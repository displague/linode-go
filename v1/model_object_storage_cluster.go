...
func (o *ObjectStorageCluster) GetStaticSiteDomain() string {
	if o == nil || o.StaticSiteDomain == nil {
		var ret string
		return ret
	}
...
func (o ObjectStorageCluster) MarshalJSON() ([]byte, error) {
	...
	if o.StaticSiteDomain != nil {
		toSerialize["static_site_domain"] = o.StaticSiteDomain
	}
	return json.Marshal(toSerialize)
}

type NullableObjectStorageCluster struct {
	value *ObjectStorageCluster
	isSet bool
}

func (v NullableObjectStorageCluster) Get() *ObjectStorageCluster {
	return v.value
}

func (v *NullableObjectStorageCluster) Set(val *ObjectStorageCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStorageCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStorageCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStorageCluster(val *ObjectStorageCluster) *NullableObjectStorageCluster {
	return &NullableObjectStorageCluster{value: val, isSet: true}
}

func (v NullableObjectStorageCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStorageCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
