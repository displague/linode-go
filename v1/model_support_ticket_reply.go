...
func (o SupportTicketReply) MarshalJSON() ([]byte, error) {
...
type NullableSupportTicketReply struct {
	value *SupportTicketReply
	isSet bool
}

func (v NullableSupportTicketReply) Get() *SupportTicketReply {
	return v.value
}

func (v *NullableSupportTicketReply) Set(val *SupportTicketReply) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportTicketReply) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportTicketReply) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportTicketReply(val *SupportTicketReply) *NullableSupportTicketReply {
	return &NullableSupportTicketReply{value: val, isSet: true}
}

func (v NullableSupportTicketReply) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportTicketReply) UnmarshalJSON(src []byte) error {
	v.isSet = true
