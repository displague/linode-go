...
func (o FirewallDevicesEntity) MarshalJSON() ([]byte, error) {
...
type NullableFirewallDevicesEntity struct {
	value *FirewallDevicesEntity
	isSet bool
}

func (v NullableFirewallDevicesEntity) Get() *FirewallDevicesEntity {
	return v.value
}

func (v *NullableFirewallDevicesEntity) Set(val *FirewallDevicesEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallDevicesEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallDevicesEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallDevicesEntity(val *FirewallDevicesEntity) *NullableFirewallDevicesEntity {
	return &NullableFirewallDevicesEntity{value: val, isSet: true}
}

func (v NullableFirewallDevicesEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallDevicesEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
