...
func (o *IPAddressPrivate) HasSubnetMask() bool {
	if o != nil && o.SubnetMask != nil {
		return true
	}
...
func (o IPAddressPrivate) MarshalJSON() ([]byte, error) {
...
type NullableIPAddressPrivate struct {
	value *IPAddressPrivate
	isSet bool
}

func (v NullableIPAddressPrivate) Get() *IPAddressPrivate {
	return v.value
}

func (v *NullableIPAddressPrivate) Set(val *IPAddressPrivate) {
	v.value = val
	v.isSet = true
}

func (v NullableIPAddressPrivate) IsSet() bool {
	return v.isSet
}

func (v *NullableIPAddressPrivate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPAddressPrivate(val *IPAddressPrivate) *NullableIPAddressPrivate {
	return &NullableIPAddressPrivate{value: val, isSet: true}
}

func (v NullableIPAddressPrivate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPAddressPrivate) UnmarshalJSON(src []byte) error {
	v.isSet = true
