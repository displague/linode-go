...
// NodeBalancerConfigNodesStatus A structure containing information about the health of the backends for this port.  This information is updated periodically as checks are performed against backends. 
...
func NewNodeBalancerConfigNodesStatus() *NodeBalancerConfigNodesStatus {
	this := NodeBalancerConfigNodesStatus{}
	return &this
}
...
func (o NodeBalancerConfigNodesStatus) MarshalJSON() ([]byte, error) {
...
type NullableNodeBalancerConfigNodesStatus struct {
	value *NodeBalancerConfigNodesStatus
	isSet bool
}

func (v NullableNodeBalancerConfigNodesStatus) Get() *NodeBalancerConfigNodesStatus {
	return v.value
}

func (v *NullableNodeBalancerConfigNodesStatus) Set(val *NodeBalancerConfigNodesStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeBalancerConfigNodesStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeBalancerConfigNodesStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeBalancerConfigNodesStatus(val *NodeBalancerConfigNodesStatus) *NullableNodeBalancerConfigNodesStatus {
	return &NullableNodeBalancerConfigNodesStatus{value: val, isSet: true}
}

func (v NullableNodeBalancerConfigNodesStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeBalancerConfigNodesStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
