...
func (o *IPv6Pool) GetRouteTarget() string {
	if o == nil || o.RouteTarget.Get() == nil {
		var ret string
		return ret
	}
...
func (o *IPv6Pool) SetRouteTargetNil() {
...
func (o IPv6Pool) MarshalJSON() ([]byte, error) {
...
type NullableIPv6Pool struct {
	value *IPv6Pool
	isSet bool
}

func (v NullableIPv6Pool) Get() *IPv6Pool {
	return v.value
}

func (v *NullableIPv6Pool) Set(val *IPv6Pool) {
	v.value = val
	v.isSet = true
}

func (v NullableIPv6Pool) IsSet() bool {
	return v.isSet
}

func (v *NullableIPv6Pool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPv6Pool(val *IPv6Pool) *NullableIPv6Pool {
	return &NullableIPv6Pool{value: val, isSet: true}
}

func (v NullableIPv6Pool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPv6Pool) UnmarshalJSON(src []byte) error {
	v.isSet = true
