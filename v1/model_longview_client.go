...
// SetApps gets a reference to the given LongviewClientApps and assigns it to the Apps field.
...
func (o LongviewClient) MarshalJSON() ([]byte, error) {
...
type NullableLongviewClient struct {
	value *LongviewClient
	isSet bool
}

func (v NullableLongviewClient) Get() *LongviewClient {
	return v.value
}

func (v *NullableLongviewClient) Set(val *LongviewClient) {
	v.value = val
	v.isSet = true
}

func (v NullableLongviewClient) IsSet() bool {
	return v.isSet
}

func (v *NullableLongviewClient) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLongviewClient(val *LongviewClient) *NullableLongviewClient {
	return &NullableLongviewClient{value: val, isSet: true}
}

func (v NullableLongviewClient) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLongviewClient) UnmarshalJSON(src []byte) error {
	v.isSet = true
