...
// LongviewClientApps The apps this Client is monitoring on your Linode. This is configured when you install the Longview Client application, and is present here for information purposes only. 
...
func (o LongviewClientApps) MarshalJSON() ([]byte, error) {
...
type NullableLongviewClientApps struct {
	value *LongviewClientApps
	isSet bool
}

func (v NullableLongviewClientApps) Get() *LongviewClientApps {
	return v.value
}

func (v *NullableLongviewClientApps) Set(val *LongviewClientApps) {
	v.value = val
	v.isSet = true
}

func (v NullableLongviewClientApps) IsSet() bool {
	return v.isSet
}

func (v *NullableLongviewClientApps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLongviewClientApps(val *LongviewClientApps) *NullableLongviewClientApps {
	return &NullableLongviewClientApps{value: val, isSet: true}
}

func (v NullableLongviewClientApps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLongviewClientApps) UnmarshalJSON(src []byte) error {
	v.isSet = true
