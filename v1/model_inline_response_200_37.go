...
type InlineResponse20037 struct {
	Data *[]ManagedLinodeSettings `json:"data,omitempty"`
...
// SetData gets a reference to the given []ManagedLinodeSettings and assigns it to the Data field.
...
// SetPages gets a reference to the given Pages and assigns it to the Pages field.
