...
type InlineResponse20016 struct {
	Automatic *[]Backup `json:"automatic,omitempty"`
	Snapshot *InlineResponse20016Snapshot `json:"snapshot,omitempty"`
}
...
// SetAutomatic gets a reference to the given []Backup and assigns it to the Automatic field.
...
func (o *InlineResponse20016) GetSnapshot() InlineResponse20016Snapshot {
	if o == nil || o.Snapshot == nil {
		var ret InlineResponse20016Snapshot
		return ret
	}
	return *o.Snapshot
}
...
// SetSnapshot gets a reference to the given InlineResponse20016Snapshot and assigns it to the Snapshot field.
