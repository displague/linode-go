...
func (o BackupDisks) MarshalJSON() ([]byte, error) {
...
type NullableBackupDisks struct {
	value *BackupDisks
	isSet bool
}

func (v NullableBackupDisks) Get() *BackupDisks {
	return v.value
}

func (v *NullableBackupDisks) Set(val *BackupDisks) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupDisks) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupDisks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupDisks(val *BackupDisks) *NullableBackupDisks {
	return &NullableBackupDisks{value: val, isSet: true}
}

func (v NullableBackupDisks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupDisks) UnmarshalJSON(src []byte) error {
	v.isSet = true
