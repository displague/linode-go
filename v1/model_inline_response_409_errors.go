...
func (o InlineResponse409Errors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse409Errors struct {
	value *InlineResponse409Errors
	isSet bool
}

func (v NullableInlineResponse409Errors) Get() *InlineResponse409Errors {
	return v.value
}

func (v *NullableInlineResponse409Errors) Set(val *InlineResponse409Errors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse409Errors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse409Errors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse409Errors(val *InlineResponse409Errors) *NullableInlineResponse409Errors {
	return &NullableInlineResponse409Errors{value: val, isSet: true}
}

func (v NullableInlineResponse409Errors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse409Errors) UnmarshalJSON(src []byte) error {
	v.isSet = true
