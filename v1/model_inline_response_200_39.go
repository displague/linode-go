...
type InlineResponse20039 struct {
	Data *OneOfStatsDataAvailablearray `json:"data,omitempty"`
}
...
func (o *InlineResponse20039) GetData() OneOfStatsDataAvailablearray {
	if o == nil || o.Data == nil {
		var ret OneOfStatsDataAvailablearray
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given OneOfStatsDataAvailablearray and assigns it to the Data field.
