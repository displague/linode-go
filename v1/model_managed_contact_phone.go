...
func (o *ManagedContactPhone) SetPrimaryNil() {
	o.Primary.Set(nil)
}
...
func (o *ManagedContactPhone) SetSecondaryNil() {
	o.Secondary.Set(nil)
}
...
func (o ManagedContactPhone) MarshalJSON() ([]byte, error) {
...
type NullableManagedContactPhone struct {
	value *ManagedContactPhone
	isSet bool
}

func (v NullableManagedContactPhone) Get() *ManagedContactPhone {
	return v.value
}

func (v *NullableManagedContactPhone) Set(val *ManagedContactPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedContactPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedContactPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedContactPhone(val *ManagedContactPhone) *NullableManagedContactPhone {
	return &NullableManagedContactPhone{value: val, isSet: true}
}

func (v NullableManagedContactPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedContactPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
