...
func (o *StackScript) GetDeploymentsTotal() int32 {
	if o == nil || o.DeploymentsTotal == nil {
		var ret int32
		return ret
	}
...
func (o *StackScript) GetDeploymentsActive() int32 {
	if o == nil || o.DeploymentsActive == nil {
		var ret int32
		return ret
	}
...
// SetUserDefinedFields gets a reference to the given []UserDefinedField and assigns it to the UserDefinedFields field.
func (o *StackScript) SetUserDefinedFields(v []UserDefinedField) {
	o.UserDefinedFields = &v
}

func (o StackScript) MarshalJSON() ([]byte, error) {
	...
	if o.DeploymentsTotal != nil {
		toSerialize["deployments_total"] = o.DeploymentsTotal
	}
	if o.DeploymentsActive != nil {
...
type NullableStackScript struct {
	value *StackScript
	isSet bool
}

func (v NullableStackScript) Get() *StackScript {
	return v.value
}

func (v *NullableStackScript) Set(val *StackScript) {
	v.value = val
	v.isSet = true
}

func (v NullableStackScript) IsSet() bool {
	return v.isSet
}

func (v *NullableStackScript) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStackScript(val *StackScript) *NullableStackScript {
	return &NullableStackScript{value: val, isSet: true}
}

func (v NullableStackScript) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStackScript) UnmarshalJSON(src []byte) error {
	v.isSet = true
