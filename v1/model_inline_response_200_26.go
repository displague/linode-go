...
// SetDisks gets a reference to the given Disks and assigns it to the Disks field.
...
// SetNodes gets a reference to the given Nodes and assigns it to the Nodes field.
