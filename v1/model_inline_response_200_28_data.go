...
func (o InlineResponse20028Data) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20028Data struct {
	value *InlineResponse20028Data
	isSet bool
}

func (v NullableInlineResponse20028Data) Get() *InlineResponse20028Data {
	return v.value
}

func (v *NullableInlineResponse20028Data) Set(val *InlineResponse20028Data) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20028Data) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20028Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20028Data(val *InlineResponse20028Data) *NullableInlineResponse20028Data {
	return &NullableInlineResponse20028Data{value: val, isSet: true}
}

func (v NullableInlineResponse20028Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20028Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
