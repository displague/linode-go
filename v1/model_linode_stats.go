...
// LinodeStats CPU, IO, IPv4, and IPv6 statistics. Graph data, if available, is in \"[timestamp, reading]\" array format. Timestamp is a UNIX timestamp in EST. 
...
// SetIo gets a reference to the given LinodeStatsIo and assigns it to the Io field.
...
func (o *LinodeStats) GetNetv4() LinodeStatsNetv4 {
	if o == nil || o.Netv4 == nil {
		var ret LinodeStatsNetv4
		return ret
	}
	return *o.Netv4
}
...
// SetNetv4 gets a reference to the given LinodeStatsNetv4 and assigns it to the Netv4 field.
...
func (o *LinodeStats) GetNetv6() LinodeStatsNetv6 {
	if o == nil || o.Netv6 == nil {
		var ret LinodeStatsNetv6
		return ret
	}
	return *o.Netv6
}
...
// SetNetv6 gets a reference to the given LinodeStatsNetv6 and assigns it to the Netv6 field.
...
func (o LinodeStats) MarshalJSON() ([]byte, error) {
...
type NullableLinodeStats struct {
	value *LinodeStats
	isSet bool
}

func (v NullableLinodeStats) Get() *LinodeStats {
	return v.value
}

func (v *NullableLinodeStats) Set(val *LinodeStats) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeStats) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeStats(val *LinodeStats) *NullableLinodeStats {
	return &NullableLinodeStats{value: val, isSet: true}
}

func (v NullableLinodeStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
