...
type LinodeTypesApiService service

type ApiGetLinodeTypeRequest struct {
	ctx _context.Context
	ApiService *LinodeTypesApiService
	typeId string
}


func (r ApiGetLinodeTypeRequest) Execute() (LinodeType, *_nethttp.Response, error) {
 ...
 */
func (a *LinodeTypesApiService) GetLinodeType(ctx _context.Context, typeId string) ApiGetLinodeTypeRequest {
	return ApiGetLinodeTypeRequest{
		ApiService: a,
		ctx: ctx,
		typeId: typeId,
 ...
 * @return LinodeType
 */
func (a *LinodeTypesApiService) GetLinodeTypeExecute(r ApiGetLinodeTypeRequest) (LinodeType, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  LinodeType
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinodeTypesApiService.GetLinodeType")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/linode/types/{typeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"typeId"+"}", _neturl.PathEscape(parameterToString(r.typeId, "")), -1)
...
func (r ApiGetLinodeTypesRequest) Execute() (InlineResponse20023, *_nethttp.Response, error) {
 ...
 */
func (a *LinodeTypesApiService) GetLinodeTypes(ctx _context.Context) ApiGetLinodeTypesRequest {
	return ApiGetLinodeTypesRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *LinodeTypesApiService) GetLinodeTypesExecute(r ApiGetLinodeTypesRequest) (InlineResponse20023, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinodeTypesApiService.GetLinodeTypes")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/linode/types"
