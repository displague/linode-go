 ...
 */
func (a *RegionsApiService) GetRegion(ctx _context.Context, regionId string) ApiGetRegionRequest {
	return ApiGetRegionRequest{
		ApiService: a,
		ctx: ctx,
		regionId: regionId,
 ...
 * @return Region
 */
func (a *RegionsApiService) GetRegionExecute(r ApiGetRegionRequest) (Region, *_nethttp.Response, error) {
	var (
...
func (r ApiGetRegionsRequest) Execute() (InlineResponse20055, *_nethttp.Response, error) {
 ...
 */
func (a *RegionsApiService) GetRegionsExecute(r ApiGetRegionsRequest) (InlineResponse20055, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
