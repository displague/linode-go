...
func NewLongviewSubscriptionPrice() *LongviewSubscriptionPrice {
	this := LongviewSubscriptionPrice{}
	return &this
}
...
func (o LongviewSubscriptionPrice) MarshalJSON() ([]byte, error) {
...
type NullableLongviewSubscriptionPrice struct {
	value *LongviewSubscriptionPrice
	isSet bool
}

func (v NullableLongviewSubscriptionPrice) Get() *LongviewSubscriptionPrice {
	return v.value
}

func (v *NullableLongviewSubscriptionPrice) Set(val *LongviewSubscriptionPrice) {
	v.value = val
	v.isSet = true
}

func (v NullableLongviewSubscriptionPrice) IsSet() bool {
	return v.isSet
}

func (v *NullableLongviewSubscriptionPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLongviewSubscriptionPrice(val *LongviewSubscriptionPrice) *NullableLongviewSubscriptionPrice {
	return &NullableLongviewSubscriptionPrice{value: val, isSet: true}
}

func (v NullableLongviewSubscriptionPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLongviewSubscriptionPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
