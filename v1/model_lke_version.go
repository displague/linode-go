...
func (o LKEVersion) MarshalJSON() ([]byte, error) {
...
type NullableLKEVersion struct {
	value *LKEVersion
	isSet bool
}

func (v NullableLKEVersion) Get() *LKEVersion {
	return v.value
}

func (v *NullableLKEVersion) Set(val *LKEVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableLKEVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableLKEVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLKEVersion(val *LKEVersion) *NullableLKEVersion {
	return &NullableLKEVersion{value: val, isSet: true}
}

func (v NullableLKEVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLKEVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
