...
func NewInlineObject3(label string) *InlineObject3 {
	this := InlineObject3{}
	this.Label = label
	return &this
}
...
func (o *InlineObject3) GetLabel() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject3) GetLabelOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Label, true
...
func (o *InlineObject3) SetLabel(v string) {
	o.Label = v
}
