...
func (o SupportTicketEntity) MarshalJSON() ([]byte, error) {
...
type NullableSupportTicketEntity struct {
	value *SupportTicketEntity
	isSet bool
}

func (v NullableSupportTicketEntity) Get() *SupportTicketEntity {
	return v.value
}

func (v *NullableSupportTicketEntity) Set(val *SupportTicketEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportTicketEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportTicketEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportTicketEntity(val *SupportTicketEntity) *NullableSupportTicketEntity {
	return &NullableSupportTicketEntity{value: val, isSet: true}
}

func (v NullableSupportTicketEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportTicketEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
