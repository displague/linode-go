...
func (o AccountCreditCard) MarshalJSON() ([]byte, error) {
...
type NullableAccountCreditCard struct {
	value *AccountCreditCard
	isSet bool
}

func (v NullableAccountCreditCard) Get() *AccountCreditCard {
	return v.value
}

func (v *NullableAccountCreditCard) Set(val *AccountCreditCard) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountCreditCard) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountCreditCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountCreditCard(val *AccountCreditCard) *NullableAccountCreditCard {
	return &NullableAccountCreditCard{value: val, isSet: true}
}

func (v NullableAccountCreditCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountCreditCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
