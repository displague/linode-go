...
type InlineObject8 struct {
	Devices *RescueDevices `json:"devices,omitempty"`
}
...
// SetDevices gets a reference to the given RescueDevices and assigns it to the Devices field.
