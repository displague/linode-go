...
func (o RegionResolvers) MarshalJSON() ([]byte, error) {
...
type NullableRegionResolvers struct {
	value *RegionResolvers
	isSet bool
}

func (v NullableRegionResolvers) Get() *RegionResolvers {
	return v.value
}

func (v *NullableRegionResolvers) Set(val *RegionResolvers) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionResolvers) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionResolvers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionResolvers(val *RegionResolvers) *NullableRegionResolvers {
	return &NullableRegionResolvers{value: val, isSet: true}
}

func (v NullableRegionResolvers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionResolvers) UnmarshalJSON(src []byte) error {
	v.isSet = true
