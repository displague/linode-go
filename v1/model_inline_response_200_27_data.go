...
func (o InlineResponse20027Data) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20027Data struct {
	value *InlineResponse20027Data
	isSet bool
}

func (v NullableInlineResponse20027Data) Get() *InlineResponse20027Data {
	return v.value
}

func (v *NullableInlineResponse20027Data) Set(val *InlineResponse20027Data) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20027Data) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20027Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20027Data(val *InlineResponse20027Data) *NullableInlineResponse20027Data {
	return &NullableInlineResponse20027Data{value: val, isSet: true}
}

func (v NullableInlineResponse20027Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20027Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
