...
// NetworkingFirewallsDevices A Firewall Device assigns a Firewall to a Linode service. Currently, Firewalls can only be assigned to Linode instances. * A Firewall can be assigned to multiple Linode services, and up to five active Firewalls can be assigned to a single Linode service. * Additional disabled Firewalls can be assigned to a service, but they cannot be enabled if five other active Firewalls are already assigned to the same service.  **Note:** When a Firewall is assigned to a Linode and you attempt to [migrate the Linode to a data center](/docs/api/linode-instances/#dc-migrationpending-host-migration-initiate) that does not support Cloud Firewalls, the migration will fail. Use the [List Regions](/docs/api/regions/#regions-list) endpoint to view a list of a data center's capabilities. 
type NetworkingFirewallsDevices struct {
...
func NewNetworkingFirewallsDevices() *NetworkingFirewallsDevices {
	this := NetworkingFirewallsDevices{}
	return &this
}
...
func (o NetworkingFirewallsDevices) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingFirewallsDevices struct {
	value *NetworkingFirewallsDevices
	isSet bool
}

func (v NullableNetworkingFirewallsDevices) Get() *NetworkingFirewallsDevices {
	return v.value
}

func (v *NullableNetworkingFirewallsDevices) Set(val *NetworkingFirewallsDevices) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingFirewallsDevices) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingFirewallsDevices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingFirewallsDevices(val *NetworkingFirewallsDevices) *NullableNetworkingFirewallsDevices {
	return &NullableNetworkingFirewallsDevices{value: val, isSet: true}
}

func (v NullableNetworkingFirewallsDevices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingFirewallsDevices) UnmarshalJSON(src []byte) error {
	v.isSet = true
