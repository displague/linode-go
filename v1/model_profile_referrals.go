...
func (o ProfileReferrals) MarshalJSON() ([]byte, error) {
...
type NullableProfileReferrals struct {
	value *ProfileReferrals
	isSet bool
}

func (v NullableProfileReferrals) Get() *ProfileReferrals {
	return v.value
}

func (v *NullableProfileReferrals) Set(val *ProfileReferrals) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileReferrals) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileReferrals) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileReferrals(val *ProfileReferrals) *NullableProfileReferrals {
	return &NullableProfileReferrals{value: val, isSet: true}
}

func (v NullableProfileReferrals) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileReferrals) UnmarshalJSON(src []byte) error {
	v.isSet = true
