...
func (o *FirewallRuleConfig) GetAddresses() FirewallRuleConfigAddresses {
	if o == nil || o.Addresses == nil {
		var ret FirewallRuleConfigAddresses
		return ret
	}
	return *o.Addresses
}
...
// SetAddresses gets a reference to the given FirewallRuleConfigAddresses and assigns it to the Addresses field.
func (o *FirewallRuleConfig) SetAddresses(v FirewallRuleConfigAddresses) {
	o.Addresses = &v
}

func (o FirewallRuleConfig) MarshalJSON() ([]byte, error) {
...
type NullableFirewallRuleConfig struct {
	value *FirewallRuleConfig
	isSet bool
}

func (v NullableFirewallRuleConfig) Get() *FirewallRuleConfig {
	return v.value
}

func (v *NullableFirewallRuleConfig) Set(val *FirewallRuleConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallRuleConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallRuleConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallRuleConfig(val *FirewallRuleConfig) *NullableFirewallRuleConfig {
	return &NullableFirewallRuleConfig{value: val, isSet: true}
}

func (v NullableFirewallRuleConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallRuleConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
