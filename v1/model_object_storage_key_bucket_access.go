...
func NewObjectStorageKeyBucketAccess() *ObjectStorageKeyBucketAccess {
	this := ObjectStorageKeyBucketAccess{}
	return &this
}
...
func (o ObjectStorageKeyBucketAccess) MarshalJSON() ([]byte, error) {
...
type NullableObjectStorageKeyBucketAccess struct {
	value *ObjectStorageKeyBucketAccess
	isSet bool
}

func (v NullableObjectStorageKeyBucketAccess) Get() *ObjectStorageKeyBucketAccess {
	return v.value
}

func (v *NullableObjectStorageKeyBucketAccess) Set(val *ObjectStorageKeyBucketAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStorageKeyBucketAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStorageKeyBucketAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStorageKeyBucketAccess(val *ObjectStorageKeyBucketAccess) *NullableObjectStorageKeyBucketAccess {
	return &NullableObjectStorageKeyBucketAccess{value: val, isSet: true}
}

func (v NullableObjectStorageKeyBucketAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStorageKeyBucketAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
