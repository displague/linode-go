...
func (o *AuthorizedApp) SetExpiryNil() {
	o.Expiry.Set(nil)
}
...
func (o AuthorizedApp) MarshalJSON() ([]byte, error) {
...
type NullableAuthorizedApp struct {
	value *AuthorizedApp
	isSet bool
}

func (v NullableAuthorizedApp) Get() *AuthorizedApp {
	return v.value
}

func (v *NullableAuthorizedApp) Set(val *AuthorizedApp) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthorizedApp) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthorizedApp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthorizedApp(val *AuthorizedApp) *NullableAuthorizedApp {
	return &NullableAuthorizedApp{value: val, isSet: true}
}

func (v NullableAuthorizedApp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthorizedApp) UnmarshalJSON(src []byte) error {
	v.isSet = true
