...
func (o ObjectStorageSSL) MarshalJSON() ([]byte, error) {
...
type NullableObjectStorageSSL struct {
	value *ObjectStorageSSL
	isSet bool
}

func (v NullableObjectStorageSSL) Get() *ObjectStorageSSL {
	return v.value
}

func (v *NullableObjectStorageSSL) Set(val *ObjectStorageSSL) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStorageSSL) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStorageSSL) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStorageSSL(val *ObjectStorageSSL) *NullableObjectStorageSSL {
	return &NullableObjectStorageSSL{value: val, isSet: true}
}

func (v NullableObjectStorageSSL) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStorageSSL) UnmarshalJSON(src []byte) error {
	v.isSet = true
