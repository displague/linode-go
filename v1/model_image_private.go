...
// SetEol gets a reference to the given time.Time and assigns it to the Eol field.
...
func (o *ImagePrivate) SetVendorNil() {
	o.Vendor.Set(nil)
}
...
func (o ImagePrivate) MarshalJSON() ([]byte, error) {
...
type NullableImagePrivate struct {
	value *ImagePrivate
	isSet bool
}

func (v NullableImagePrivate) Get() *ImagePrivate {
	return v.value
}

func (v *NullableImagePrivate) Set(val *ImagePrivate) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePrivate) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePrivate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePrivate(val *ImagePrivate) *NullableImagePrivate {
	return &NullableImagePrivate{value: val, isSet: true}
}

func (v NullableImagePrivate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePrivate) UnmarshalJSON(src []byte) error {
	v.isSet = true
