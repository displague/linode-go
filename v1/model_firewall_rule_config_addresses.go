...
// FirewallRuleConfigAddresses Allowed IPv4 or IPv6 addresses. A Rule can have up to 255 addresses or networks listed across its IPv4 and IPv6 arrays. A network and a single IP are treated as equivalent when accounting for this limit. 
...
func NewFirewallRuleConfigAddresses() *FirewallRuleConfigAddresses {
	this := FirewallRuleConfigAddresses{}
	return &this
}
...
func (o FirewallRuleConfigAddresses) MarshalJSON() ([]byte, error) {
...
type NullableFirewallRuleConfigAddresses struct {
	value *FirewallRuleConfigAddresses
	isSet bool
}

func (v NullableFirewallRuleConfigAddresses) Get() *FirewallRuleConfigAddresses {
	return v.value
}

func (v *NullableFirewallRuleConfigAddresses) Set(val *FirewallRuleConfigAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallRuleConfigAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallRuleConfigAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallRuleConfigAddresses(val *FirewallRuleConfigAddresses) *NullableFirewallRuleConfigAddresses {
	return &NullableFirewallRuleConfigAddresses{value: val, isSet: true}
}

func (v NullableFirewallRuleConfigAddresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallRuleConfigAddresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
