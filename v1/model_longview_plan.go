...
type LongviewPlan struct {
	// The subscription ID for a particular Longview plan. A value of `null` corresponds to Longview Free.  You can send a request to the [List Longview Subscriptions](/docs/api/longview/#longview-subscriptions-list) endpoint to receive the details of each plan. 
...
func (o *LongviewPlan) GetLongviewSubscription() string {
	if o == nil || o.LongviewSubscription.Get() == nil {
		var ret string
		return ret
	}
...
func (o *LongviewPlan) SetLongviewSubscriptionNil() {
...
func (o LongviewPlan) MarshalJSON() ([]byte, error) {
...
type NullableLongviewPlan struct {
	value *LongviewPlan
	isSet bool
}

func (v NullableLongviewPlan) Get() *LongviewPlan {
	return v.value
}

func (v *NullableLongviewPlan) Set(val *LongviewPlan) {
	v.value = val
	v.isSet = true
}

func (v NullableLongviewPlan) IsSet() bool {
	return v.isSet
}

func (v *NullableLongviewPlan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLongviewPlan(val *LongviewPlan) *NullableLongviewPlan {
	return &NullableLongviewPlan{value: val, isSet: true}
}

func (v NullableLongviewPlan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLongviewPlan) UnmarshalJSON(src []byte) error {
	v.isSet = true
