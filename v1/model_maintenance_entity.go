...
func (o MaintenanceEntity) MarshalJSON() ([]byte, error) {
...
type NullableMaintenanceEntity struct {
	value *MaintenanceEntity
	isSet bool
}

func (v NullableMaintenanceEntity) Get() *MaintenanceEntity {
	return v.value
}

func (v *NullableMaintenanceEntity) Set(val *MaintenanceEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceEntity(val *MaintenanceEntity) *NullableMaintenanceEntity {
	return &NullableMaintenanceEntity{value: val, isSet: true}
}

func (v NullableMaintenanceEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
