...
// SetPhone gets a reference to the given ManagedContactPhone and assigns it to the Phone field.
...
func (o *ManagedContact) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o ManagedContact) MarshalJSON() ([]byte, error) {
...
type NullableManagedContact struct {
	value *ManagedContact
	isSet bool
}

func (v NullableManagedContact) Get() *ManagedContact {
	return v.value
}

func (v *NullableManagedContact) Set(val *ManagedContact) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedContact) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedContact(val *ManagedContact) *NullableManagedContact {
	return &NullableManagedContact{value: val, isSet: true}
}

func (v NullableManagedContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
