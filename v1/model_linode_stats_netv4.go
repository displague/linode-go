...
// NewLinodeStatsNetv4 instantiates a new LinodeStatsNetv4 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLinodeStatsNetv4() *LinodeStatsNetv4 {
	this := LinodeStatsNetv4{}
	return &this
}

// NewLinodeStatsNetv4WithDefaults instantiates a new LinodeStatsNetv4 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewLinodeStatsNetv4WithDefaults() *LinodeStatsNetv4 {
	this := LinodeStatsNetv4{}
	return &this
}

// GetIn returns the In field value if set, zero value otherwise.
func (o *LinodeStatsNetv4) GetIn() [][]float32 {
	if o == nil || o.In == nil {
		var ret [][]float32
		return ret
	}
...
func (o *LinodeStatsNetv4) GetInOk() (*[][]float32, bool) {
	if o == nil || o.In == nil {
		return nil, false
	}
	return o.In, true
...
func (o *LinodeStatsNetv4) HasIn() bool {
	if o != nil && o.In != nil {
		return true
	}
...
func (o *LinodeStatsNetv4) SetIn(v [][]float32) {
	o.In = &v
}

// GetOut returns the Out field value if set, zero value otherwise.
func (o *LinodeStatsNetv4) GetOut() [][]float32 {
	if o == nil || o.Out == nil {
		var ret [][]float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LinodeStatsNetv4) GetOutOk() (*[][]float32, bool) {
	if o == nil || o.Out == nil {
		return nil, false
	}
	return o.Out, true
...
func (o *LinodeStatsNetv4) HasOut() bool {
	if o != nil && o.Out != nil {
		return true
	}
...
func (o *LinodeStatsNetv4) SetOut(v [][]float32) {
	o.Out = &v
}

// GetPrivateIn returns the PrivateIn field value if set, zero value otherwise.
func (o *LinodeStatsNetv4) GetPrivateIn() [][]float32 {
	if o == nil || o.PrivateIn == nil {
		var ret [][]float32
		return ret
	}
	return *o.PrivateIn
...
// and a boolean to check if the value has been set.
func (o *LinodeStatsNetv4) GetPrivateInOk() (*[][]float32, bool) {
	if o == nil || o.PrivateIn == nil {
		return nil, false
	}
...
func (o *LinodeStatsNetv4) HasPrivateIn() bool {
	if o != nil && o.PrivateIn != nil {
		return true
	}
...
func (o *LinodeStatsNetv4) SetPrivateIn(v [][]float32) {
	o.PrivateIn = &v
}

// GetPrivateOut returns the PrivateOut field value if set, zero value otherwise.
func (o *LinodeStatsNetv4) GetPrivateOut() [][]float32 {
	if o == nil || o.PrivateOut == nil {
		var ret [][]float32
		return ret
	}
	return *o.PrivateOut
...
// and a boolean to check if the value has been set.
func (o *LinodeStatsNetv4) GetPrivateOutOk() (*[][]float32, bool) {
	if o == nil || o.PrivateOut == nil {
		return nil, false
	}
...
func (o *LinodeStatsNetv4) HasPrivateOut() bool {
	if o != nil && o.PrivateOut != nil {
		return true
	}
...
func (o *LinodeStatsNetv4) SetPrivateOut(v [][]float32) {
	o.PrivateOut = &v
}

func (o LinodeStatsNetv4) MarshalJSON() ([]byte, error) {
...
type NullableLinodeStatsNetv4 struct {
	value *LinodeStatsNetv4
	isSet bool
}

func (v NullableLinodeStatsNetv4) Get() *LinodeStatsNetv4 {
	return v.value
}

func (v *NullableLinodeStatsNetv4) Set(val *LinodeStatsNetv4) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeStatsNetv4) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeStatsNetv4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeStatsNetv4(val *LinodeStatsNetv4) *NullableLinodeStatsNetv4 {
	return &NullableLinodeStatsNetv4{value: val, isSet: true}
}

func (v NullableLinodeStatsNetv4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeStatsNetv4) UnmarshalJSON(src []byte) error {
	v.isSet = true
