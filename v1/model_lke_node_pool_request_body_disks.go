...
type LKENodePoolRequestBodyDisks struct {
	// The size of this custom disk partition in MB.    * The size of this disk partition must not exceed the capacity of the node's plan type. 
...
func NewLKENodePoolRequestBodyDisks() *LKENodePoolRequestBodyDisks {
	this := LKENodePoolRequestBodyDisks{}
	return &this
}
...
func (o LKENodePoolRequestBodyDisks) MarshalJSON() ([]byte, error) {
...
type NullableLKENodePoolRequestBodyDisks struct {
	value *LKENodePoolRequestBodyDisks
	isSet bool
}

func (v NullableLKENodePoolRequestBodyDisks) Get() *LKENodePoolRequestBodyDisks {
	return v.value
}

func (v *NullableLKENodePoolRequestBodyDisks) Set(val *LKENodePoolRequestBodyDisks) {
	v.value = val
	v.isSet = true
}

func (v NullableLKENodePoolRequestBodyDisks) IsSet() bool {
	return v.isSet
}

func (v *NullableLKENodePoolRequestBodyDisks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLKENodePoolRequestBodyDisks(val *LKENodePoolRequestBodyDisks) *NullableLKENodePoolRequestBodyDisks {
	return &NullableLKENodePoolRequestBodyDisks{value: val, isSet: true}
}

func (v NullableLKENodePoolRequestBodyDisks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLKENodePoolRequestBodyDisks) UnmarshalJSON(src []byte) error {
	v.isSet = true
