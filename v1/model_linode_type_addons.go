...
func (o *LinodeTypeAddons) GetBackups() LinodeTypeAddonsBackups {
	if o == nil || o.Backups == nil {
		var ret LinodeTypeAddonsBackups
		return ret
	}
	return *o.Backups
}
...
// SetBackups gets a reference to the given LinodeTypeAddonsBackups and assigns it to the Backups field.
func (o *LinodeTypeAddons) SetBackups(v LinodeTypeAddonsBackups) {
	o.Backups = &v
}

func (o LinodeTypeAddons) MarshalJSON() ([]byte, error) {
...
type NullableLinodeTypeAddons struct {
	value *LinodeTypeAddons
	isSet bool
}

func (v NullableLinodeTypeAddons) Get() *LinodeTypeAddons {
	return v.value
}

func (v *NullableLinodeTypeAddons) Set(val *LinodeTypeAddons) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeTypeAddons) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeTypeAddons) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeTypeAddons(val *LinodeTypeAddons) *NullableLinodeTypeAddons {
	return &NullableLinodeTypeAddons{value: val, isSet: true}
}

func (v NullableLinodeTypeAddons) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeTypeAddons) UnmarshalJSON(src []byte) error {
	v.isSet = true
