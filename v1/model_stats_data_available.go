...
// SetCpu gets a reference to the given []StatsData and assigns it to the Cpu field.
...
// SetDisk gets a reference to the given []StatsData and assigns it to the Disk field.
...
// SetSwap gets a reference to the given []StatsData and assigns it to the Swap field.
...
// SetNetIn gets a reference to the given []StatsData and assigns it to the NetIn field.
...
// SetNetOut gets a reference to the given []StatsData and assigns it to the NetOut field.
func (o *StatsDataAvailable) SetNetOut(v []StatsData) {
	o.NetOut = &v
}

func (o StatsDataAvailable) MarshalJSON() ([]byte, error) {
...
type NullableStatsDataAvailable struct {
	value *StatsDataAvailable
	isSet bool
}

func (v NullableStatsDataAvailable) Get() *StatsDataAvailable {
	return v.value
}

func (v *NullableStatsDataAvailable) Set(val *StatsDataAvailable) {
	v.value = val
	v.isSet = true
}

func (v NullableStatsDataAvailable) IsSet() bool {
	return v.isSet
}

func (v *NullableStatsDataAvailable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatsDataAvailable(val *StatsDataAvailable) *NullableStatsDataAvailable {
	return &NullableStatsDataAvailable{value: val, isSet: true}
}

func (v NullableStatsDataAvailable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatsDataAvailable) UnmarshalJSON(src []byte) error {
	v.isSet = true
