...
type InlineResponse20016Snapshot struct {
	InProgress *Backup `json:"in_progress,omitempty"`
	Current *Backup `json:"current,omitempty"`
}
...
func NewInlineResponse20016Snapshot() *InlineResponse20016Snapshot {
	this := InlineResponse20016Snapshot{}
	return &this
}
...
// SetInProgress gets a reference to the given Backup and assigns it to the InProgress field.
...
// SetCurrent gets a reference to the given Backup and assigns it to the Current field.
func (o *InlineResponse20016Snapshot) SetCurrent(v Backup) {
	o.Current = &v
}

func (o InlineResponse20016Snapshot) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20016Snapshot struct {
	value *InlineResponse20016Snapshot
	isSet bool
}

func (v NullableInlineResponse20016Snapshot) Get() *InlineResponse20016Snapshot {
	return v.value
}

func (v *NullableInlineResponse20016Snapshot) Set(val *InlineResponse20016Snapshot) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20016Snapshot) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20016Snapshot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20016Snapshot(val *InlineResponse20016Snapshot) *NullableInlineResponse20016Snapshot {
	return &NullableInlineResponse20016Snapshot{value: val, isSet: true}
}

func (v NullableInlineResponse20016Snapshot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20016Snapshot) UnmarshalJSON(src []byte) error {
	v.isSet = true
