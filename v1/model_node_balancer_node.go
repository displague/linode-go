...
func (o NodeBalancerNode) MarshalJSON() ([]byte, error) {
...
type NullableNodeBalancerNode struct {
	value *NodeBalancerNode
	isSet bool
}

func (v NullableNodeBalancerNode) Get() *NodeBalancerNode {
	return v.value
}

func (v *NullableNodeBalancerNode) Set(val *NodeBalancerNode) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeBalancerNode) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeBalancerNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeBalancerNode(val *NodeBalancerNode) *NullableNodeBalancerNode {
	return &NullableNodeBalancerNode{value: val, isSet: true}
}

func (v NullableNodeBalancerNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeBalancerNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
