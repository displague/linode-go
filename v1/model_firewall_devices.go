...
// SetEntity gets a reference to the given FirewallDevicesEntity and assigns it to the Entity field.
func (o *FirewallDevices) SetEntity(v FirewallDevicesEntity) {
	o.Entity = &v
}

func (o FirewallDevices) MarshalJSON() ([]byte, error) {
...
type NullableFirewallDevices struct {
	value *FirewallDevices
	isSet bool
}

func (v NullableFirewallDevices) Get() *FirewallDevices {
	return v.value
}

func (v *NullableFirewallDevices) Set(val *FirewallDevices) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallDevices) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallDevices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallDevices(val *FirewallDevices) *NullableFirewallDevices {
	return &NullableFirewallDevices{value: val, isSet: true}
}

func (v NullableFirewallDevices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallDevices) UnmarshalJSON(src []byte) error {
	v.isSet = true
