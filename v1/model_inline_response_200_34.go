...
type InlineResponse20034 struct {
	Data *[]ManagedCredential `json:"data,omitempty"`
...
// SetData gets a reference to the given []ManagedCredential and assigns it to the Data field.
