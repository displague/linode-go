...
type InlineResponse20032 struct {
	Data *[]LongviewSubscription `json:"data,omitempty"`
...
// SetData gets a reference to the given []LongviewSubscription and assigns it to the Data field.
