...
func (r ApiCloseTicketRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *SupportApiService) CloseTicket(ctx _context.Context, ticketId int32) ApiCloseTicketRequest {
	return ApiCloseTicketRequest{
		ApiService: a,
		ctx: ctx,
		ticketId: ticketId,
 ...
 */
func (a *SupportApiService) CloseTicketExecute(r ApiCloseTicketRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SupportApiService.CloseTicket")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/support/tickets/{ticketId}/close"
...
func (r ApiCreateTicketRequest) SupportTicketRequest(supportTicketRequest SupportTicketRequest) ApiCreateTicketRequest {
	r.supportTicketRequest = &supportTicketRequest
	return r
}

func (r ApiCreateTicketRequest) Execute() (SupportTicket, *_nethttp.Response, error) {
 ...
 */
func (a *SupportApiService) CreateTicket(ctx _context.Context) ApiCreateTicketRequest {
	return ApiCreateTicketRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *SupportApiService) CreateTicketExecute(r ApiCreateTicketRequest) (SupportTicket, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = r.supportTicketRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiCreateTicketAttachmentRequest struct {
	ctx _context.Context
	ApiService *SupportApiService
	ticketId int32
	file *string
...
func (r ApiCreateTicketAttachmentRequest) File(file string) ApiCreateTicketAttachmentRequest {
	r.file = &file
	return r
}

func (r ApiCreateTicketAttachmentRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
	return r.ApiService.CreateTicketAttachmentExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ticketId The ID of the Support Ticket.
 * @return ApiCreateTicketAttachmentRequest
 */
func (a *SupportApiService) CreateTicketAttachment(ctx _context.Context, ticketId int32) ApiCreateTicketAttachmentRequest {
	return ApiCreateTicketAttachmentRequest{
		ApiService: a,
		ctx: ctx,
		ticketId: ticketId,
 ...
 * @return map[string]interface{}
 */
func (a *SupportApiService) CreateTicketAttachmentExecute(r ApiCreateTicketAttachmentRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SupportApiService.CreateTicketAttachment")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/support/tickets/{ticketId}/attachments"
	localVarPath = strings.Replace(localVarPath, "{"+"ticketId"+"}", _neturl.PathEscape(parameterToString(r.ticketId, "")), -1)
...
func (r ApiCreateTicketReplyRequest) Execute() (SupportTicketReply, *_nethttp.Response, error) {
 ...
 */
func (a *SupportApiService) CreateTicketReply(ctx _context.Context, ticketId int32) ApiCreateTicketReplyRequest {
	return ApiCreateTicketReplyRequest{
		ApiService: a,
		ctx: ctx,
		ticketId: ticketId,
 ...
 */
func (a *SupportApiService) CreateTicketReplyExecute(r ApiCreateTicketReplyRequest) (SupportTicketReply, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  SupportTicketReply
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SupportApiService.CreateTicketReply")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/support/tickets/{ticketId}/replies"
	localVarPath = strings.Replace(localVarPath, "{"+"ticketId"+"}", _neturl.PathEscape(parameterToString(r.ticketId, "")), -1)
...
func (r ApiGetTicketRequest) Execute() (SupportTicket, *_nethttp.Response, error) {
 ...
 */
func (a *SupportApiService) GetTicket(ctx _context.Context, ticketId int32) ApiGetTicketRequest {
	return ApiGetTicketRequest{
		ApiService: a,
		ctx: ctx,
		ticketId: ticketId,
 ...
 * @return SupportTicket
 */
func (a *SupportApiService) GetTicketExecute(r ApiGetTicketRequest) (SupportTicket, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/support/tickets/{ticketId}"
	localVarPath = strings.Replace(localVarPath, "{"+"ticketId"+"}", _neturl.PathEscape(parameterToString(r.ticketId, "")), -1)
...
func (r ApiGetTicketRepliesRequest) Execute() (InlineResponse20057, *_nethttp.Response, error) {
 ...
 */
func (a *SupportApiService) GetTicketReplies(ctx _context.Context, ticketId int32) ApiGetTicketRepliesRequest {
	return ApiGetTicketRepliesRequest{
		ApiService: a,
		ctx: ctx,
		ticketId: ticketId,
 ...
 */
func (a *SupportApiService) GetTicketRepliesExecute(r ApiGetTicketRepliesRequest) (InlineResponse20057, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetTicketsRequest) Execute() (InlineResponse20056, *_nethttp.Response, error) {
 ...
 */
func (a *SupportApiService) GetTickets(ctx _context.Context) ApiGetTicketsRequest {
	return ApiGetTicketsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *SupportApiService) GetTicketsExecute(r ApiGetTicketsRequest) (InlineResponse20056, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
