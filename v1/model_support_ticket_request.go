...
// SupportTicketRequest An object representing a created Support Ticket - a question or issue and request for help from the Linode support team. Only one of the ID attributes (`linode_id`, `domain_id`, etc.) can be set on a single Support Ticket. 
...
func (o *SupportTicketRequest) GetLongviewclientId() int32 {
	if o == nil || o.LongviewclientId == nil {
		var ret int32
		return ret
	}
...
func (o SupportTicketRequest) MarshalJSON() ([]byte, error) {
...
type NullableSupportTicketRequest struct {
	value *SupportTicketRequest
	isSet bool
}

func (v NullableSupportTicketRequest) Get() *SupportTicketRequest {
	return v.value
}

func (v *NullableSupportTicketRequest) Set(val *SupportTicketRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportTicketRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportTicketRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportTicketRequest(val *SupportTicketRequest) *NullableSupportTicketRequest {
	return &NullableSupportTicketRequest{value: val, isSet: true}
}

func (v NullableSupportTicketRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportTicketRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
