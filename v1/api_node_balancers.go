...
type ApiCreateNodeBalancerRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
	uNKNOWNBASETYPE *UNKNOWN_BASE_TYPE
}

func (r ApiCreateNodeBalancerRequest) UNKNOWNBASETYPE(uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) ApiCreateNodeBalancerRequest {
	r.uNKNOWNBASETYPE = &uNKNOWNBASETYPE
	return r
}

func (r ApiCreateNodeBalancerRequest) Execute() (NodeBalancer, *_nethttp.Response, error) {
	return r.ApiService.CreateNodeBalancerExecute(r)
}
 ...
 * @return ApiCreateNodeBalancerRequest
 */
func (a *NodeBalancersApiService) CreateNodeBalancer(ctx _context.Context) ApiCreateNodeBalancerRequest {
	return ApiCreateNodeBalancerRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return NodeBalancer
 */
func (a *NodeBalancersApiService) CreateNodeBalancerExecute(r ApiCreateNodeBalancerRequest) (NodeBalancer, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.CreateNodeBalancer")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/nodebalancers"
...
type ApiCreateNodeBalancerConfigRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
...
func (r ApiCreateNodeBalancerConfigRequest) NodeBalancerConfig(nodeBalancerConfig NodeBalancerConfig) ApiCreateNodeBalancerConfigRequest {
	r.nodeBalancerConfig = &nodeBalancerConfig
	return r
}

func (r ApiCreateNodeBalancerConfigRequest) Execute() (NodeBalancerConfig, *_nethttp.Response, error) {
	return r.ApiService.CreateNodeBalancerConfigExecute(r)
}
 ...
 * @return ApiCreateNodeBalancerConfigRequest
 */
func (a *NodeBalancersApiService) CreateNodeBalancerConfig(ctx _context.Context, nodeBalancerId int32) ApiCreateNodeBalancerConfigRequest {
	return ApiCreateNodeBalancerConfigRequest{
		ApiService: a,
		ctx: ctx,
 ...
 */
func (a *NodeBalancersApiService) CreateNodeBalancerConfigExecute(r ApiCreateNodeBalancerConfigRequest) (NodeBalancerConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.CreateNodeBalancerConfig")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/nodebalancers/{nodeBalancerId}/configs"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", _neturl.PathEscape(parameterToString(r.nodeBalancerId, "")), -1)
	...
	// body params
	localVarPostBody = r.nodeBalancerConfig
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiCreateNodeBalancerNodeRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
	nodeBalancerId int32
	configId int32
...
func (r ApiCreateNodeBalancerNodeRequest) UNKNOWNBASETYPE(uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) ApiCreateNodeBalancerNodeRequest {
	r.uNKNOWNBASETYPE = &uNKNOWNBASETYPE
	return r
}

func (r ApiCreateNodeBalancerNodeRequest) Execute() (NodeBalancerNode, *_nethttp.Response, error) {
	return r.ApiService.CreateNodeBalancerNodeExecute(r)
}
 ...
 * @return ApiCreateNodeBalancerNodeRequest
 */
func (a *NodeBalancersApiService) CreateNodeBalancerNode(ctx _context.Context, nodeBalancerId int32, configId int32) ApiCreateNodeBalancerNodeRequest {
	return ApiCreateNodeBalancerNodeRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 */
func (a *NodeBalancersApiService) CreateNodeBalancerNodeExecute(r ApiCreateNodeBalancerNodeRequest) (NodeBalancerNode, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.CreateNodeBalancerNode")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/nodebalancers/{nodeBalancerId}/configs/{configId}/nodes"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", _neturl.PathEscape(parameterToString(r.nodeBalancerId, "")), -1)
...
func (r ApiDeleteNodeBalancerRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) DeleteNodeBalancer(ctx _context.Context, nodeBalancerId int32) ApiDeleteNodeBalancerRequest {
	return ApiDeleteNodeBalancerRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 */
func (a *NodeBalancersApiService) DeleteNodeBalancerExecute(r ApiDeleteNodeBalancerRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/nodebalancers/{nodeBalancerId}"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", _neturl.PathEscape(parameterToString(r.nodeBalancerId, "")), -1)
...
func (r ApiDeleteNodeBalancerConfigRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) DeleteNodeBalancerConfig(ctx _context.Context, nodeBalancerId int32, configId int32) ApiDeleteNodeBalancerConfigRequest {
	return ApiDeleteNodeBalancerConfigRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return map[string]interface{}
 */
func (a *NodeBalancersApiService) DeleteNodeBalancerConfigExecute(r ApiDeleteNodeBalancerConfigRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/nodebalancers/{nodeBalancerId}/configs/{configId}"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", _neturl.PathEscape(parameterToString(r.nodeBalancerId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"configId"+"}", _neturl.PathEscape(parameterToString(r.configId, "")), -1)
...
func (r ApiDeleteNodeBalancerConfigNodeRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) DeleteNodeBalancerConfigNode(ctx _context.Context, nodeBalancerId int32, configId int32, nodeId int32) ApiDeleteNodeBalancerConfigNodeRequest {
	return ApiDeleteNodeBalancerConfigNodeRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return map[string]interface{}
 */
func (a *NodeBalancersApiService) DeleteNodeBalancerConfigNodeExecute(r ApiDeleteNodeBalancerConfigNodeRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/nodebalancers/{nodeBalancerId}/configs/{configId}/nodes/{nodeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", _neturl.PathEscape(parameterToString(r.nodeBalancerId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"configId"+"}", _neturl.PathEscape(parameterToString(r.configId, "")), -1)
...
func (r ApiGetNodeBalancerRequest) Execute() (NodeBalancer, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancer(ctx _context.Context, nodeBalancerId int32) ApiGetNodeBalancerRequest {
	return ApiGetNodeBalancerRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return NodeBalancer
 */
func (a *NodeBalancersApiService) GetNodeBalancerExecute(r ApiGetNodeBalancerRequest) (NodeBalancer, *_nethttp.Response, error) {
	var (
...
func (r ApiGetNodeBalancerConfigRequest) Execute() (NodeBalancerConfig, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancerConfig(ctx _context.Context, nodeBalancerId int32, configId int32) ApiGetNodeBalancerConfigRequest {
	return ApiGetNodeBalancerConfigRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return NodeBalancerConfig
 */
func (a *NodeBalancersApiService) GetNodeBalancerConfigExecute(r ApiGetNodeBalancerConfigRequest) (NodeBalancerConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetNodeBalancerConfigNodesRequest) Execute() (InlineResponse20046, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancerConfigNodes(ctx _context.Context, nodeBalancerId int32, configId int32) ApiGetNodeBalancerConfigNodesRequest {
	return ApiGetNodeBalancerConfigNodesRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancerConfigNodesExecute(r ApiGetNodeBalancerConfigNodesRequest) (InlineResponse20046, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetNodeBalancerConfigsRequest) Execute() (InlineResponse20045, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancerConfigs(ctx _context.Context, nodeBalancerId int32) ApiGetNodeBalancerConfigsRequest {
	return ApiGetNodeBalancerConfigsRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancerConfigsExecute(r ApiGetNodeBalancerConfigsRequest) (InlineResponse20045, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetNodeBalancerNodeRequest) Execute() (NodeBalancerNode, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancerNode(ctx _context.Context, nodeBalancerId int32, configId int32, nodeId int32) ApiGetNodeBalancerNodeRequest {
	return ApiGetNodeBalancerNodeRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return NodeBalancerNode
 */
func (a *NodeBalancersApiService) GetNodeBalancerNodeExecute(r ApiGetNodeBalancerNodeRequest) (NodeBalancerNode, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetNodeBalancersRequest) Execute() (InlineResponse20044, *_nethttp.Response, error) {
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancers(ctx _context.Context) ApiGetNodeBalancersRequest {
	return ApiGetNodeBalancersRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *NodeBalancersApiService) GetNodeBalancersExecute(r ApiGetNodeBalancersRequest) (InlineResponse20044, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
type ApiNodebalancersNodeBalancerIdStatsGetRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
	nodeBalancerId int32
}
...
func (r ApiNodebalancersNodeBalancerIdStatsGetRequest) Execute() (NodeBalancerStats, *_nethttp.Response, error) {
	return r.ApiService.NodebalancersNodeBalancerIdStatsGetExecute(r)
}

/*
 * NodebalancersNodeBalancerIdStatsGet NodeBalancer Statistics View
 * Returns detailed statistics about the requested NodeBalancer.

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param nodeBalancerId The ID of the NodeBalancer to access.
 * @return ApiNodebalancersNodeBalancerIdStatsGetRequest
 */
func (a *NodeBalancersApiService) NodebalancersNodeBalancerIdStatsGet(ctx _context.Context, nodeBalancerId int32) ApiNodebalancersNodeBalancerIdStatsGetRequest {
	return ApiNodebalancersNodeBalancerIdStatsGetRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 */
func (a *NodeBalancersApiService) NodebalancersNodeBalancerIdStatsGetExecute(r ApiNodebalancersNodeBalancerIdStatsGetRequest) (NodeBalancerStats, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.NodebalancersNodeBalancerIdStatsGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/nodebalancers/{nodeBalancerId}/stats"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", _neturl.PathEscape(parameterToString(r.nodeBalancerId, "")), -1)
...
type ApiRebuildNodeBalancerConfigRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
	nodeBalancerId int32
	configId int32
...
func (r ApiRebuildNodeBalancerConfigRequest) UNKNOWNBASETYPE(uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) ApiRebuildNodeBalancerConfigRequest {
	r.uNKNOWNBASETYPE = &uNKNOWNBASETYPE
	return r
}

func (r ApiRebuildNodeBalancerConfigRequest) Execute() (NodeBalancer, *_nethttp.Response, error) {
	return r.ApiService.RebuildNodeBalancerConfigExecute(r)
}
 ...
 * @param nodeBalancerId The ID of the NodeBalancer to access.
 * @param configId The ID of the Config to access.
 * @return ApiRebuildNodeBalancerConfigRequest
 */
func (a *NodeBalancersApiService) RebuildNodeBalancerConfig(ctx _context.Context, nodeBalancerId int32, configId int32) ApiRebuildNodeBalancerConfigRequest {
	return ApiRebuildNodeBalancerConfigRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return NodeBalancer
 */
func (a *NodeBalancersApiService) RebuildNodeBalancerConfigExecute(r ApiRebuildNodeBalancerConfigRequest) (NodeBalancer, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.RebuildNodeBalancerConfig")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/nodebalancers/{nodeBalancerId}/configs/{configId}/rebuild"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", _neturl.PathEscape(parameterToString(r.nodeBalancerId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"configId"+"}", _neturl.PathEscape(parameterToString(r.configId, "")), -1)
...
type ApiUpdateNodeBalancerRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
	nodeBalancerId int32
...
func (r ApiUpdateNodeBalancerRequest) NodeBalancer(nodeBalancer NodeBalancer) ApiUpdateNodeBalancerRequest {
	r.nodeBalancer = &nodeBalancer
	return r
}

func (r ApiUpdateNodeBalancerRequest) Execute() (NodeBalancer, *_nethttp.Response, error) {
	return r.ApiService.UpdateNodeBalancerExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param nodeBalancerId The ID of the NodeBalancer to access.
 * @return ApiUpdateNodeBalancerRequest
 */
func (a *NodeBalancersApiService) UpdateNodeBalancer(ctx _context.Context, nodeBalancerId int32) ApiUpdateNodeBalancerRequest {
	return ApiUpdateNodeBalancerRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return NodeBalancer
 */
func (a *NodeBalancersApiService) UpdateNodeBalancerExecute(r ApiUpdateNodeBalancerRequest) (NodeBalancer, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.UpdateNodeBalancer")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateNodeBalancerConfigRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
	nodeBalancerId int32
	configId int32
...
func (r ApiUpdateNodeBalancerConfigRequest) NodeBalancerConfig(nodeBalancerConfig NodeBalancerConfig) ApiUpdateNodeBalancerConfigRequest {
	r.nodeBalancerConfig = &nodeBalancerConfig
	return r
}

func (r ApiUpdateNodeBalancerConfigRequest) Execute() (NodeBalancerConfig, *_nethttp.Response, error) {
	return r.ApiService.UpdateNodeBalancerConfigExecute(r)
}
 ...
 * @param nodeBalancerId The ID of the NodeBalancer to access.
 * @param configId The ID of the config to access.
 * @return ApiUpdateNodeBalancerConfigRequest
 */
func (a *NodeBalancersApiService) UpdateNodeBalancerConfig(ctx _context.Context, nodeBalancerId int32, configId int32) ApiUpdateNodeBalancerConfigRequest {
	return ApiUpdateNodeBalancerConfigRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return NodeBalancerConfig
 */
func (a *NodeBalancersApiService) UpdateNodeBalancerConfigExecute(r ApiUpdateNodeBalancerConfigRequest) (NodeBalancerConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.UpdateNodeBalancerConfig")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.nodeBalancerConfig == nil {
		return localVarReturnValue, nil, reportError("nodeBalancerConfig is required and must be specified")
	}
...
type ApiUpdateNodeBalancerNodeRequest struct {
	ctx _context.Context
	ApiService *NodeBalancersApiService
	nodeBalancerId int32
	configId int32
...
func (r ApiUpdateNodeBalancerNodeRequest) NodeBalancerNode(nodeBalancerNode NodeBalancerNode) ApiUpdateNodeBalancerNodeRequest {
	r.nodeBalancerNode = &nodeBalancerNode
	return r
}

func (r ApiUpdateNodeBalancerNodeRequest) Execute() (NodeBalancerNode, *_nethttp.Response, error) {
	return r.ApiService.UpdateNodeBalancerNodeExecute(r)
}
 ...
 * @param configId The ID of the Config to access
 * @param nodeId The ID of the Node to access
 * @return ApiUpdateNodeBalancerNodeRequest
 */
func (a *NodeBalancersApiService) UpdateNodeBalancerNode(ctx _context.Context, nodeBalancerId int32, configId int32, nodeId int32) ApiUpdateNodeBalancerNodeRequest {
	return ApiUpdateNodeBalancerNodeRequest{
		ApiService: a,
		ctx: ctx,
		nodeBalancerId: nodeBalancerId,
 ...
 * @return NodeBalancerNode
 */
func (a *NodeBalancersApiService) UpdateNodeBalancerNodeExecute(r ApiUpdateNodeBalancerNodeRequest) (NodeBalancerNode, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeBalancersApiService.UpdateNodeBalancerNode")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.nodeBalancerNode == nil {
		return localVarReturnValue, nil, reportError("nodeBalancerNode is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.nodeBalancerNode
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
