...
func (o *AccountActivePromotions) GetCreditMonthlyCap() string {
	if o == nil || o.CreditMonthlyCap == nil {
		var ret string
		return ret
	}
...
func (o *AccountActivePromotions) SetCreditMonthlyCap(v string) {
...
func (o *AccountActivePromotions) GetCreditRemaining() string {
	if o == nil || o.CreditRemaining == nil {
		var ret string
		return ret
	}
...
func (o *AccountActivePromotions) HasDescription() bool {
	if o != nil && o.Description != nil {
		return true
	}
...
func (o *AccountActivePromotions) GetThisMonthCreditRemaining() string {
	if o == nil || o.ThisMonthCreditRemaining == nil {
		var ret string
		return ret
	}
...
func (o AccountActivePromotions) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.CreditMonthlyCap != nil {
		toSerialize["credit_monthly_cap"] = o.CreditMonthlyCap
	}
	if o.CreditRemaining != nil {
	...
	if o.ThisMonthCreditRemaining != nil {
		toSerialize["this_month_credit_remaining"] = o.ThisMonthCreditRemaining
	}
	return json.Marshal(toSerialize)
}

type NullableAccountActivePromotions struct {
	value *AccountActivePromotions
	isSet bool
}

func (v NullableAccountActivePromotions) Get() *AccountActivePromotions {
	return v.value
}

func (v *NullableAccountActivePromotions) Set(val *AccountActivePromotions) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountActivePromotions) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountActivePromotions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountActivePromotions(val *AccountActivePromotions) *NullableAccountActivePromotions {
	return &NullableAccountActivePromotions{value: val, isSet: true}
}

func (v NullableAccountActivePromotions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountActivePromotions) UnmarshalJSON(src []byte) error {
	v.isSet = true
