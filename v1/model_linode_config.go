...
type LinodeConfig struct {
	...
	// Controls the virtualization mode. Defaults to `paravirt`. * `paravirt` is suitable for most cases. Linodes running in paravirt mode   share some qualities with the host, ultimately making it run faster since   there is less transition between it and the host. * `full_virt` affords more customization, but is slower because 100% of the VM   is virtualized. 
...
func (o *LinodeConfig) SetCommentsNil() {
	o.Comments.Set(nil)
}
...
func (o *LinodeConfig) GetHelpers() LinodeConfigHelpers {
	if o == nil || o.Helpers == nil {
		var ret LinodeConfigHelpers
		return ret
	}
	return *o.Helpers
}
...
// SetHelpers gets a reference to the given LinodeConfigHelpers and assigns it to the Helpers field.
...
func (o LinodeConfig) MarshalJSON() ([]byte, error) {
...
type NullableLinodeConfig struct {
	value *LinodeConfig
	isSet bool
}

func (v NullableLinodeConfig) Get() *LinodeConfig {
	return v.value
}

func (v *NullableLinodeConfig) Set(val *LinodeConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeConfig(val *LinodeConfig) *NullableLinodeConfig {
	return &NullableLinodeConfig{value: val, isSet: true}
}

func (v NullableLinodeConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
