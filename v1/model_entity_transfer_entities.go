...
func (o EntityTransferEntities) MarshalJSON() ([]byte, error) {
...
type NullableEntityTransferEntities struct {
	value *EntityTransferEntities
	isSet bool
}

func (v NullableEntityTransferEntities) Get() *EntityTransferEntities {
	return v.value
}

func (v *NullableEntityTransferEntities) Set(val *EntityTransferEntities) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityTransferEntities) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityTransferEntities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityTransferEntities(val *EntityTransferEntities) *NullableEntityTransferEntities {
	return &NullableEntityTransferEntities{value: val, isSet: true}
}

func (v NullableEntityTransferEntities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityTransferEntities) UnmarshalJSON(src []byte) error {
	v.isSet = true
