...
func (o SSHKeyRequest) MarshalJSON() ([]byte, error) {
...
type NullableSSHKeyRequest struct {
	value *SSHKeyRequest
	isSet bool
}

func (v NullableSSHKeyRequest) Get() *SSHKeyRequest {
	return v.value
}

func (v *NullableSSHKeyRequest) Set(val *SSHKeyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSSHKeyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSSHKeyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSSHKeyRequest(val *SSHKeyRequest) *NullableSSHKeyRequest {
	return &NullableSSHKeyRequest{value: val, isSet: true}
}

func (v NullableSSHKeyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSSHKeyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
