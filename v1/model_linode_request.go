...
type LinodeRequest struct {
	Image *Image `json:"image,omitempty"`
	RootPass *RootPass `json:"root_pass,omitempty"`
	AuthorizedKeys *AuthorizedKeys `json:"authorized_keys,omitempty"`
	AuthorizedUsers *AuthorizedUsers `json:"authorized_users,omitempty"`
	StackscriptId *StackscriptId `json:"stackscript_id,omitempty"`
	StackscriptData *StackscriptData `json:"stackscript_data,omitempty"`
...
// SetAuthorizedKeys gets a reference to the given AuthorizedKeys and assigns it to the AuthorizedKeys field.
...
// SetAuthorizedUsers gets a reference to the given AuthorizedUsers and assigns it to the AuthorizedUsers field.
...
// SetStackscriptId gets a reference to the given StackscriptId and assigns it to the StackscriptId field.
...
// SetStackscriptData gets a reference to the given StackscriptData and assigns it to the StackscriptData field.
...
func (o LinodeRequest) MarshalJSON() ([]byte, error) {
...
type NullableLinodeRequest struct {
	value *LinodeRequest
	isSet bool
}

func (v NullableLinodeRequest) Get() *LinodeRequest {
	return v.value
}

func (v *NullableLinodeRequest) Set(val *LinodeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeRequest(val *LinodeRequest) *NullableLinodeRequest {
	return &NullableLinodeRequest{value: val, isSet: true}
}

func (v NullableLinodeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
