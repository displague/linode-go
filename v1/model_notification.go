...
func (o *Notification) GetEntityOk() (*NotificationEntity, bool) {
	if o == nil || o.Entity == nil {
		return nil, false
	}
...
// SetEntity gets a reference to the given NotificationEntity and assigns it to the Entity field.
