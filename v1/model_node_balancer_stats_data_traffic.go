...
func NewNodeBalancerStatsDataTraffic() *NodeBalancerStatsDataTraffic {
	this := NodeBalancerStatsDataTraffic{}
	return &this
}
...
func (o NodeBalancerStatsDataTraffic) MarshalJSON() ([]byte, error) {
...
type NullableNodeBalancerStatsDataTraffic struct {
	value *NodeBalancerStatsDataTraffic
	isSet bool
}

func (v NullableNodeBalancerStatsDataTraffic) Get() *NodeBalancerStatsDataTraffic {
	return v.value
}

func (v *NullableNodeBalancerStatsDataTraffic) Set(val *NodeBalancerStatsDataTraffic) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeBalancerStatsDataTraffic) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeBalancerStatsDataTraffic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeBalancerStatsDataTraffic(val *NodeBalancerStatsDataTraffic) *NullableNodeBalancerStatsDataTraffic {
	return &NullableNodeBalancerStatsDataTraffic{value: val, isSet: true}
}

func (v NullableNodeBalancerStatsDataTraffic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeBalancerStatsDataTraffic) UnmarshalJSON(src []byte) error {
	v.isSet = true
