...
type ApiAddStackScriptRequest struct {
	ctx _context.Context
	ApiService *StackScriptsApiService
	uNKNOWNBASETYPE *UNKNOWN_BASE_TYPE
}

func (r ApiAddStackScriptRequest) UNKNOWNBASETYPE(uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) ApiAddStackScriptRequest {
	r.uNKNOWNBASETYPE = &uNKNOWNBASETYPE
	return r
}

func (r ApiAddStackScriptRequest) Execute() (StackScript, *_nethttp.Response, error) {
	return r.ApiService.AddStackScriptExecute(r)
}
 ...
 * @return ApiAddStackScriptRequest
 */
func (a *StackScriptsApiService) AddStackScript(ctx _context.Context) ApiAddStackScriptRequest {
	return ApiAddStackScriptRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return StackScript
 */
func (a *StackScriptsApiService) AddStackScriptExecute(r ApiAddStackScriptRequest) (StackScript, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StackScriptsApiService.AddStackScript")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/linode/stackscripts"
...
func (r ApiDeleteStackScriptRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *StackScriptsApiService) DeleteStackScript(ctx _context.Context, stackscriptId string) ApiDeleteStackScriptRequest {
	return ApiDeleteStackScriptRequest{
		ApiService: a,
		ctx: ctx,
 ...
 */
func (a *StackScriptsApiService) DeleteStackScriptExecute(r ApiDeleteStackScriptRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StackScriptsApiService.DeleteStackScript")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/linode/stackscripts/{stackscriptId}"
	localVarPath = strings.Replace(localVarPath, "{"+"stackscriptId"+"}", _neturl.PathEscape(parameterToString(r.stackscriptId, "")), -1)
...
func (r ApiGetStackScriptRequest) Execute() (StackScript, *_nethttp.Response, error) {
 ...
 */
func (a *StackScriptsApiService) GetStackScript(ctx _context.Context, stackscriptId string) ApiGetStackScriptRequest {
	return ApiGetStackScriptRequest{
		ApiService: a,
		ctx: ctx,
		stackscriptId: stackscriptId,
 ...
 * @return StackScript
 */
func (a *StackScriptsApiService) GetStackScriptExecute(r ApiGetStackScriptRequest) (StackScript, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StackScriptsApiService.GetStackScript")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetStackScriptsRequest) Execute() (InlineResponse20022, *_nethttp.Response, error) {
 ...
 */
func (a *StackScriptsApiService) GetStackScripts(ctx _context.Context) ApiGetStackScriptsRequest {
	return ApiGetStackScriptsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *StackScriptsApiService) GetStackScriptsExecute(r ApiGetStackScriptsRequest) (InlineResponse20022, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StackScriptsApiService.GetStackScripts")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateStackScriptRequest struct {
	ctx _context.Context
	ApiService *StackScriptsApiService
	stackscriptId string
...
func (r ApiUpdateStackScriptRequest) StackScript(stackScript StackScript) ApiUpdateStackScriptRequest {
	r.stackScript = &stackScript
	return r
}

func (r ApiUpdateStackScriptRequest) Execute() (StackScript, *_nethttp.Response, error) {
	return r.ApiService.UpdateStackScriptExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param stackscriptId The ID of the StackScript to look up.
 * @return ApiUpdateStackScriptRequest
 */
func (a *StackScriptsApiService) UpdateStackScript(ctx _context.Context, stackscriptId string) ApiUpdateStackScriptRequest {
	return ApiUpdateStackScriptRequest{
		ApiService: a,
		ctx: ctx,
		stackscriptId: stackscriptId,
 ...
 * @return StackScript
 */
func (a *StackScriptsApiService) UpdateStackScriptExecute(r ApiUpdateStackScriptRequest) (StackScript, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StackScriptsApiService.UpdateStackScript")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.stackScript
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
