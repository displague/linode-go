...
**Entity** | Pointer to [**EventEntity**](EventEntity.md) |  | [optional] 
**SecondaryEntity** | Pointer to [**EventSecondaryEntity**](EventSecondaryEntity.md) |  | [optional] 
...
**Username** | Pointer to **string** | The username of the User who caused the Event.  | [optional] [readonly] 
