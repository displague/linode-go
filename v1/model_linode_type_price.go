...
func (o LinodeTypePrice) MarshalJSON() ([]byte, error) {
...
type NullableLinodeTypePrice struct {
	value *LinodeTypePrice
	isSet bool
}

func (v NullableLinodeTypePrice) Get() *LinodeTypePrice {
	return v.value
}

func (v *NullableLinodeTypePrice) Set(val *LinodeTypePrice) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeTypePrice) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeTypePrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeTypePrice(val *LinodeTypePrice) *NullableLinodeTypePrice {
	return &NullableLinodeTypePrice{value: val, isSet: true}
}

func (v NullableLinodeTypePrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeTypePrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
