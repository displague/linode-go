...
func (o ManagedLinodeSettingsSsh) MarshalJSON() ([]byte, error) {
...
type NullableManagedLinodeSettingsSsh struct {
	value *ManagedLinodeSettingsSsh
	isSet bool
}

func (v NullableManagedLinodeSettingsSsh) Get() *ManagedLinodeSettingsSsh {
	return v.value
}

func (v *NullableManagedLinodeSettingsSsh) Set(val *ManagedLinodeSettingsSsh) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedLinodeSettingsSsh) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedLinodeSettingsSsh) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedLinodeSettingsSsh(val *ManagedLinodeSettingsSsh) *NullableManagedLinodeSettingsSsh {
	return &NullableManagedLinodeSettingsSsh{value: val, isSet: true}
}

func (v NullableManagedLinodeSettingsSsh) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedLinodeSettingsSsh) UnmarshalJSON(src []byte) error {
	v.isSet = true
