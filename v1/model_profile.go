...
// Profile A Profile represents your User in our system. This is where you can change information about your User. This information is available to any OAuth Client regardless of requested scopes, and can be used to populate User information in third-party applications. 
type Profile struct {
...
// SetReferrals gets a reference to the given ProfileReferrals and assigns it to the Referrals field.
...
func (o *Profile) GetIpWhitelistEnabled() bool {
	if o == nil || o.IpWhitelistEnabled == nil {
		var ret bool
		return ret
	}
