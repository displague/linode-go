...
func (o *LinodeConfigHelpers) GetUpdatedbDisabled() bool {
	if o == nil || o.UpdatedbDisabled == nil {
		var ret bool
		return ret
	}
...
func (o *LinodeConfigHelpers) GetDevtmpfsAutomount() bool {
	if o == nil || o.DevtmpfsAutomount == nil {
		var ret bool
		return ret
	}
...
func (o LinodeConfigHelpers) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.UpdatedbDisabled != nil {
	...
	if o.DevtmpfsAutomount != nil {
		toSerialize["devtmpfs_automount"] = o.DevtmpfsAutomount
	}
	return json.Marshal(toSerialize)
}

type NullableLinodeConfigHelpers struct {
	value *LinodeConfigHelpers
	isSet bool
}

func (v NullableLinodeConfigHelpers) Get() *LinodeConfigHelpers {
	return v.value
}

func (v *NullableLinodeConfigHelpers) Set(val *LinodeConfigHelpers) {
	v.value = val
	v.isSet = true
}

func (v NullableLinodeConfigHelpers) IsSet() bool {
	return v.isSet
}

func (v *NullableLinodeConfigHelpers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinodeConfigHelpers(val *LinodeConfigHelpers) *NullableLinodeConfigHelpers {
	return &NullableLinodeConfigHelpers{value: val, isSet: true}
}

func (v NullableLinodeConfigHelpers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinodeConfigHelpers) UnmarshalJSON(src []byte) error {
	v.isSet = true
