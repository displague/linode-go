...
// SetEntity gets a reference to the given ManagedIssueEntity and assigns it to the Entity field.
func (o *ManagedIssue) SetEntity(v ManagedIssueEntity) {
	o.Entity = &v
}

func (o ManagedIssue) MarshalJSON() ([]byte, error) {
...
type NullableManagedIssue struct {
	value *ManagedIssue
	isSet bool
}

func (v NullableManagedIssue) Get() *ManagedIssue {
	return v.value
}

func (v *NullableManagedIssue) Set(val *ManagedIssue) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedIssue) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedIssue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedIssue(val *ManagedIssue) *NullableManagedIssue {
	return &NullableManagedIssue{value: val, isSet: true}
}

func (v NullableManagedIssue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedIssue) UnmarshalJSON(src []byte) error {
	v.isSet = true
