...
func (o *ObjectStorageObject) SetNextMarkerNil() {
...
func (o ObjectStorageObject) MarshalJSON() ([]byte, error) {
...
type NullableObjectStorageObject struct {
	value *ObjectStorageObject
	isSet bool
}

func (v NullableObjectStorageObject) Get() *ObjectStorageObject {
	return v.value
}

func (v *NullableObjectStorageObject) Set(val *ObjectStorageObject) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStorageObject) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStorageObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStorageObject(val *ObjectStorageObject) *NullableObjectStorageObject {
	return &NullableObjectStorageObject{value: val, isSet: true}
}

func (v NullableObjectStorageObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStorageObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
