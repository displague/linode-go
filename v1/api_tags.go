...
func (r ApiCreateTagRequest) InlineObject15(inlineObject15 InlineObject15) ApiCreateTagRequest {
 ...
 * @return Tag
 */
func (a *TagsApiService) CreateTagExecute(r ApiCreateTagRequest) (Tag, *_nethttp.Response, error) {
	var (
...
func (r ApiDeleteTagRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *TagsApiService) DeleteTag(ctx _context.Context, label string) ApiDeleteTagRequest {
	return ApiDeleteTagRequest{
		ApiService: a,
		ctx: ctx,
		label: label,
 ...
 */
func (a *TagsApiService) DeleteTagExecute(r ApiDeleteTagRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/tags/{label}"
	localVarPath = strings.Replace(localVarPath, "{"+"label"+"}", _neturl.PathEscape(parameterToString(r.label, "")), -1)
...
func (r ApiGetTaggedObjectsRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *TagsApiService) GetTaggedObjects(ctx _context.Context, label string) ApiGetTaggedObjectsRequest {
	return ApiGetTaggedObjectsRequest{
		ApiService: a,
		ctx: ctx,
		label: label,
 ...
 * @return map[string]interface{}
 */
func (a *TagsApiService) GetTaggedObjectsExecute(r ApiGetTaggedObjectsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (r ApiGetTagsRequest) Execute() (InlineResponse20058, *_nethttp.Response, error) {
 ...
 */
func (a *TagsApiService) GetTags(ctx _context.Context) ApiGetTagsRequest {
	return ApiGetTagsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *TagsApiService) GetTagsExecute(r ApiGetTagsRequest) (InlineResponse20058, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
