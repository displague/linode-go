...
// ManagedLinodeSettings Settings for a specific Linode related to Managed Services. There is one ManagedLinodeSettings object for each Linode on your Account. 
...
func (o *ManagedLinodeSettings) GetSsh() ManagedLinodeSettingsSsh {
	if o == nil || o.Ssh == nil {
		var ret ManagedLinodeSettingsSsh
		return ret
	}
	return *o.Ssh
}
...
// SetSsh gets a reference to the given ManagedLinodeSettingsSsh and assigns it to the Ssh field.
func (o *ManagedLinodeSettings) SetSsh(v ManagedLinodeSettingsSsh) {
	o.Ssh = &v
}

func (o ManagedLinodeSettings) MarshalJSON() ([]byte, error) {
...
type NullableManagedLinodeSettings struct {
	value *ManagedLinodeSettings
	isSet bool
}

func (v NullableManagedLinodeSettings) Get() *ManagedLinodeSettings {
	return v.value
}

func (v *NullableManagedLinodeSettings) Set(val *ManagedLinodeSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedLinodeSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedLinodeSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedLinodeSettings(val *ManagedLinodeSettings) *NullableManagedLinodeSettings {
	return &NullableManagedLinodeSettings{value: val, isSet: true}
}

func (v NullableManagedLinodeSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedLinodeSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
